...
class ApplicationElement extends j_l_Object {
  ...
  * @public
  */
 static $create__org_jboss_elemento_sample_j2cl_TodoRepository(repository) {
  ...
  * @public
  */
 $ctor__org_jboss_elemento_sample_j2cl_ApplicationElement__org_jboss_elemento_sample_j2cl_TodoRepository(repository) {
  ...
  * @public
  */
 m_newTodo__elemental2_dom_Event_$p_org_jboss_elemento_sample_j2cl_ApplicationElement(event) {
  ...
  * @public
  */
 m_filter__java_lang_String_$pp_org_jboss_elemento_sample_j2cl(token) {
