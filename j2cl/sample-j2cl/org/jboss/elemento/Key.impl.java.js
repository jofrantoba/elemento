...
class Key extends Enum {
  ...
  * @public
  */
 $ctor__org_jboss_elemento_Key__java_lang_String__int__java_lang_String($name, $ordinal, key) {
  ...
  * @public
  */
 $ctor__org_jboss_elemento_Key__java_lang_String__int__java_lang_String__arrayOf_java_lang_String($name, $ordinal, key, alternatives) {
  this.f_name__java_lang_Enum_ = $name;
  this.f_ordinal__java_lang_Enum_ = $ordinal;
