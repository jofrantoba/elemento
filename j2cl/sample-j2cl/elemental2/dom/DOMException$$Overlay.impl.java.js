...
class $Overlay {
 ...
 static $clinit() {
  $Overlay.$clinit = () =>{};
  $Overlay.$loadModules();
  $Overlay.$f_ABORT_ERR__elemental2_dom_DOMException_$Overlay = DOMException.ABORT_ERR;
  $Overlay.$f_DATA_CLONE_ERR__elemental2_dom_DOMException_$Overlay = DOMException.DATA_CLONE_ERR;
  $Overlay.$f_DOMSTRING_SIZE_ERR__elemental2_dom_DOMException_$Overlay = DOMException.DOMSTRING_SIZE_ERR;
  $Overlay.$f_HIERARCHY_REQUEST_ERR__elemental2_dom_DOMException_$Overlay = DOMException.HIERARCHY_REQUEST_ERR;
  $Overlay.$f_INDEX_SIZE_ERR__elemental2_dom_DOMException_$Overlay = DOMException.INDEX_SIZE_ERR;
  $Overlay.$f_INUSE_ATTRIBUTE_ERR__elemental2_dom_DOMException_$Overlay = DOMException.INUSE_ATTRIBUTE_ERR;
  $Overlay.$f_INVALID_ACCESS_ERR__elemental2_dom_DOMException_$Overlay = DOMException.INVALID_ACCESS_ERR;
  $Overlay.$f_INVALID_CHARACTER_ERR__elemental2_dom_DOMException_$Overlay = DOMException.INVALID_CHARACTER_ERR;
  $Overlay.$f_INVALID_MODIFICATION_ERR__elemental2_dom_DOMException_$Overlay = DOMException.INVALID_MODIFICATION_ERR;
  $Overlay.$f_INVALID_NODE_TYPE_ERR__elemental2_dom_DOMException_$Overlay = DOMException.INVALID_NODE_TYPE_ERR;
  $Overlay.$f_INVALID_STATE_ERR__elemental2_dom_DOMException_$Overlay = DOMException.INVALID_STATE_ERR;
  $Overlay.$f_NAMESPACE_ERR__elemental2_dom_DOMException_$Overlay = DOMException.NAMESPACE_ERR;
  $Overlay.$f_NETWORK_ERR__elemental2_dom_DOMException_$Overlay = DOMException.NETWORK_ERR;
  $Overlay.$f_NOT_FOUND_ERR__elemental2_dom_DOMException_$Overlay = DOMException.NOT_FOUND_ERR;
  $Overlay.$f_NOT_SUPPORTED_ERR__elemental2_dom_DOMException_$Overlay = DOMException.NOT_SUPPORTED_ERR;
  $Overlay.$f_NO_DATA_ALLOWED_ERR__elemental2_dom_DOMException_$Overlay = DOMException.NO_DATA_ALLOWED_ERR;
  $Overlay.$f_NO_MODIFICATION_ALLOWED_ERR__elemental2_dom_DOMException_$Overlay = DOMException.NO_MODIFICATION_ALLOWED_ERR;
  $Overlay.$f_QUOTA_EXCEEDED_ERR__elemental2_dom_DOMException_$Overlay = DOMException.QUOTA_EXCEEDED_ERR;
  $Overlay.$f_SECURITY_ERR__elemental2_dom_DOMException_$Overlay = DOMException.SECURITY_ERR;
  $Overlay.$f_SYNTAX_ERR__elemental2_dom_DOMException_$Overlay = DOMException.SYNTAX_ERR;
  $Overlay.$f_TIMEOUT_ERR__elemental2_dom_DOMException_$Overlay = DOMException.TIMEOUT_ERR;
  $Overlay.$f_TYPE_MISMATCH_ERR__elemental2_dom_DOMException_$Overlay = DOMException.TYPE_MISMATCH_ERR;
  $Overlay.$f_URL_MISMATCH_ERR__elemental2_dom_DOMException_$Overlay = DOMException.URL_MISMATCH_ERR;
