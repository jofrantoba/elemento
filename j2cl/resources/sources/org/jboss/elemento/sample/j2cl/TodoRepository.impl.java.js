...
class TodoRepository extends j_l_Object {
  ...
  * @public
  */
 $ctor__org_jboss_elemento_sample_j2cl_TodoRepository__java_lang_String(key) {
  ...
  * @public
  */
 m_complete__org_jboss_elemento_sample_j2cl_Todo__boolean(item, completed) {
  let items = this.m_load___$p_org_jboss_elemento_sample_j2cl_TodoRepository();
  ...
  * @public
  */
 m_rename__org_jboss_elemento_sample_j2cl_Todo__java_lang_String(item, text) {
  let items = this.m_load___$p_org_jboss_elemento_sample_j2cl_TodoRepository();
  let existingItem = /**@type {Object} */ ($Casts.$to(items.get(item.id), Todo_$Overlay));
  if (!$Equality.$same(existingItem, null)) {
  ...
  * @public
  */
 m_remove__org_jboss_elemento_sample_j2cl_Todo(item) {
  let items = this.m_load___$p_org_jboss_elemento_sample_j2cl_TodoRepository();
  ...
  * @public
  */
 m_onExternalModification__org_jboss_elemento_sample_j2cl_TodoRepository_ModificationCallback(callback) {
  ...
  * @public
  */
 m_save__java_util_Collection_$p_org_jboss_elemento_sample_j2cl_TodoRepository(items) {
  if (!$Equality.$same(this.f_storage__org_jboss_elemento_sample_j2cl_TodoRepository_, null)) {
