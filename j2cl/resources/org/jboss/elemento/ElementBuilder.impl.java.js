...
class ElementBuilder extends j_l_Object {
  ...
  * @public
  */
 $ctor__org_jboss_elemento_ElementBuilder__elemental2_dom_HTMLElement(element) {
  ...
  * @public
  */
 m_on__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn(type, callback) {
  ...
  * @public
  */
 m_findAll__org_jboss_elemento_By(selector) {
  ...
  * @public
  */
 m_find__org_jboss_elemento_By(selector) {
  ...
  * @public
  */
 m_closest__org_jboss_elemento_By(selector) {
