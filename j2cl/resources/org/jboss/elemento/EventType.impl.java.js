...
class EventType extends j_l_Object {
  ...
  * @public
  */
 static m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn(target, type, listener) {
  EventType.$clinit();
  ...
  * @public
  */
 static m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__boolean__org_jboss_elemento_EventCallbackFn(target, type, useCapture, listener) {
  EventType.$clinit();
  ...
  * @public
  */
 static m_bind__org_jboss_elemento_IsElement__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn(target, type, listener) {
  EventType.$clinit();
  ...
  * @public
  */
 static m_bind__org_jboss_elemento_IsElement__java_lang_String__elemental2_dom_EventListener(target, type, listener) {
  EventType.$clinit();
  ...
  * @public
  */
 static m_bind__org_jboss_elemento_IsElement__org_jboss_elemento_EventType__boolean__org_jboss_elemento_EventCallbackFn(target, type, useCapture, listener) {
  EventType.$clinit();
  ...
  * @public
  */
 static m_bind__org_jboss_elemento_IsElement__java_lang_String__boolean__elemental2_dom_EventListener(target, type, useCapture, listener) {
  EventType.$clinit();
  ...
  * @public
  */
 $ctor__org_jboss_elemento_EventType__java_lang_String(name) {
