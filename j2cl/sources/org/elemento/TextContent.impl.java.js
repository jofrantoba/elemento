goog.module('org.elemento.TextContent$impl');
...
class TextContent {
  ...
  * @public
  */
 static m_textContent__$default__org_elemento_TextContent__java_lang_String($thisArg, text) {
  TextContent.$clinit();
 ...
 static $markImplementor(classConstructor) {
   ...
   * @public {boolean}
   */
  classConstructor.prototype.$implements__org_elemento_TextContent = true;
 }
 /**
  * @param {?} instance
  * @return {boolean}
 ...
 static $isInstance(instance) {
  return instance != null && !!instance.$implements__org_elemento_TextContent;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadataForInterface(TextContent, 'org.elemento.TextContent');
