goog.module('org.elemento.sample.j2cl.TodoRepository$impl');
...
let $LambdaAdaptor$1 = goog.forwardDeclare('org.elemento.sample.j2cl.TodoRepository.$LambdaAdaptor$1$impl');
let ModificationCallback = goog.forwardDeclare('org.elemento.sample.j2cl.TodoRepository.ModificationCallback$impl');
...
class TodoRepository extends j_l_Object {
 ...
 constructor() {
  super();
  /** @public {?string} */
  this.f_key__org_elemento_sample_j2cl_TodoRepository_;
  /** @public {Storage} */
  this.f_storage__org_elemento_sample_j2cl_TodoRepository_;
 }
 /**
  * @return {?string}
  * @public
 ...
 static m_uuid__() {
  ...
  for (let i = 0; i < 36; i++) {
   if (uuid[i] == 0) {
    ...
    $Arrays.$set(uuid, i, TodoRepository.f_CHARS__org_elemento_sample_j2cl_TodoRepository_[(i == 19) ? (r & 3) | 8 : r & 15]);
   }
  }
 ...
 static $create__() {
  ...
  $instance.$ctor__org_elemento_sample_j2cl_TodoRepository__();
  return $instance;
 }
 /**
  ...
  * @public
  */
 $ctor__org_elemento_sample_j2cl_TodoRepository__() {
  this.$ctor__org_elemento_sample_j2cl_TodoRepository__java_lang_String(TodoRepository.f_DEFAULT_KEY__org_elemento_sample_j2cl_TodoRepository_);
 }
 /**
 ...
 static $create__java_lang_String(key) {
  TodoRepository.$clinit();
  let $instance = new TodoRepository();
  $instance.$ctor__org_elemento_sample_j2cl_TodoRepository__java_lang_String(key);
  return $instance;
 }
 /**
  ...
  * @public
  */
 $ctor__org_elemento_sample_j2cl_TodoRepository__java_lang_String(key) {
  this.$ctor__java_lang_Object__();
  this.f_key__org_elemento_sample_j2cl_TodoRepository_ = key;
  this.f_storage__org_elemento_sample_j2cl_TodoRepository_ = $Overlay.m_of__elemental2_dom_Window(window.window).localStorage;
 }
 /**
  * @param {?string} text
  * @return {Object}
 ...
 m_add__java_lang_String(text) {
  ...
  let items = this.m_load___$p_org_elemento_sample_j2cl_TodoRepository();
  items.put(item.id, item);
  this.m_save__java_util_Collection_$p_org_elemento_sample_j2cl_TodoRepository(items.values());
  return item;
 }
 /**
 ...
 m_completeAll__boolean(completed) {
  ...
  this.m_save__java_util_Collection_$p_org_elemento_sample_j2cl_TodoRepository(this.m_items__());
 }
 /**
  * @param {Object} item
  * @param {boolean} completed
  * @public
  */
 m_complete__org_elemento_sample_j2cl_Todo__boolean(item, completed) {
  let items = this.m_load___$p_org_elemento_sample_j2cl_TodoRepository();
  ...
  * @public
  */
 m_rename__org_elemento_sample_j2cl_Todo__java_lang_String(item, text) {
  let items = this.m_load___$p_org_elemento_sample_j2cl_TodoRepository();
  let existingItem = /**@type {Object} */ ($Casts.$to(items.get(item.id), Todo_$Overlay));
  if (!$Equality.$same(existingItem, null)) {
  ...
  */
 m_items__() {
  return this.m_load___$p_org_elemento_sample_j2cl_TodoRepository().values();
 }
 /**
  * @param {Object} item
  * @public
  */
 m_remove__org_elemento_sample_j2cl_Todo(item) {
  let items = this.m_load___$p_org_elemento_sample_j2cl_TodoRepository();
  ...
  * @public
  */
 m_onExternalModification__org_elemento_sample_j2cl_TodoRepository_ModificationCallback(callback) {
  if (!$Equality.$same(this.f_storage__org_elemento_sample_j2cl_TodoRepository_, null)) {
   EventTarget_$Overlay.m_addEventListener__$devirt__elemental2_dom_EventTarget__java_lang_String__elemental2_dom_EventListener__boolean($Overlay.m_of__elemental2_dom_Window(window.window), "storage", new $LambdaAdaptor$1((/** Event */ event) =>{
    ...
    if (j_l_String.m_equals__java_lang_String__java_lang_Object(this.f_key__org_elemento_sample_j2cl_TodoRepository_, storageEvent.key)) {
  ...
  * @public
  */
 m_load___$p_org_elemento_sample_j2cl_TodoRepository() {
  let items = /**@type {!LinkedHashMap<?string, Object>} */ (LinkedHashMap.$create__());
  if (!$Equality.$same(this.f_storage__org_elemento_sample_j2cl_TodoRepository_, null)) {
   let json = this.f_storage__org_elemento_sample_j2cl_TodoRepository_.getItem(this.f_key__org_elemento_sample_j2cl_TodoRepository_);
  ...
  * @public
  */
 m_save__java_util_Collection_$p_org_elemento_sample_j2cl_TodoRepository(items) {
  if (!$Equality.$same(this.f_storage__org_elemento_sample_j2cl_TodoRepository_, null)) {
   let todos = /**@type {Array<Object>} */ ($Arrays.$castToNative(items.m_toArray__arrayOf_java_lang_Object(new Array(0))));
   this.f_storage__org_elemento_sample_j2cl_TodoRepository_.setItem(this.f_key__org_elemento_sample_j2cl_TodoRepository_, window.JSON.stringify(todos));
  }
 }
 /**
  * @public
 ...
 static $clinit() {
  ...
  j_l_Object.$clinit();
  TodoRepository.f_CHARS__org_elemento_sample_j2cl_TodoRepository_ = j_l_String.m_toCharArray__java_lang_String("0123456789ABCDEFGHIJKLMNOPQRSTUVWXYZabcdefghijklmnopqrstuvwxyz");
 }
 /**
  * @param {?} instance
  * @return {boolean}
 ...
 static $loadModules() {
  ...
  $LambdaAdaptor$1 = goog.module.get('org.elemento.sample.j2cl.TodoRepository.$LambdaAdaptor$1$impl');
...
$Util.$setClassMetadata(TodoRepository, 'org.elemento.sample.j2cl.TodoRepository');

/** @public {?string} @const */
TodoRepository.f_DEFAULT_KEY__org_elemento_sample_j2cl_TodoRepository_ = "todos-elemento";
/** @public {Array<number>} */
TodoRepository.f_CHARS__org_elemento_sample_j2cl_TodoRepository_;
