goog.module('org.elemento.Elements$impl');
...
let BodyObserver = goog.forwardDeclare('org.elemento.BodyObserver$impl');
let By = goog.forwardDeclare('org.elemento.By$impl');
let ElementCreator = goog.forwardDeclare('org.elemento.ElementCreator$impl');
let $1 = goog.forwardDeclare('org.elemento.Elements.$1$impl');
let AsHTMLElement = goog.forwardDeclare('org.elemento.Elements.AsHTMLElement$impl');
let FilterHTMLElements = goog.forwardDeclare('org.elemento.Elements.FilterHTMLElements$impl');
let JsArrayElementIterator = goog.forwardDeclare('org.elemento.Elements.JsArrayElementIterator$impl');
let JsArrayLikeIterator = goog.forwardDeclare('org.elemento.Elements.JsArrayLikeIterator$impl');
let JsArrayNodeIterator = goog.forwardDeclare('org.elemento.Elements.JsArrayNodeIterator$impl');
let ElementsBag = goog.forwardDeclare('org.elemento.ElementsBag$impl');
let EmptyContentBuilder = goog.forwardDeclare('org.elemento.EmptyContentBuilder$impl');
...
let TextContentBuilder = goog.forwardDeclare('org.elemento.TextContentBuilder$impl');
...
class Elements extends j_l_Object {
  ...
  * @public
  */
 static m_input__org_elemento_InputType(type) {
  Elements.$clinit();
 ...
 static m_createElement__java_lang_String__java_lang_Class(element, type) {
  Elements.$clinit();
  return Elements.$f_createElement__org_elemento_Elements.m_create__java_lang_String__java_lang_Class(element, type);
 }
 /**
  * @template E
  * @param {E} element
  ...
  * @public
  */
 static m_findAll__elemental2_dom_Node__org_elemento_By(node, selector) {
  Elements.$clinit();
  let nodes = node.querySelectorAll(selector.m_selector___$pp_org_elemento());
  ...
  * @public
  */
 static m_findAll__org_elemento_IsElement__org_elemento_By(element, selector) {
  Elements.$clinit();
  return Elements.m_findAll__elemental2_dom_Node__org_elemento_By(element.m_element__(), selector);
 }
 /**
  * @template E
  * @param {Node} node
  ...
  * @public
  */
 static m_find__elemental2_dom_Node__org_elemento_By(node, selector) {
  Elements.$clinit();
  return /**@type {E} */ ($Casts.$to(Js.m_cast__java_lang_Object(node.querySelector(selector.m_selector___$pp_org_elemento())), HTMLElement_$Overlay));
 }
 /**
  * @template E, F
  * @param {IsElement<E>} element
  ...
  * @public
  */
 static m_find__org_elemento_IsElement__org_elemento_By(element, selector) {
  Elements.$clinit();
  return Elements.m_find__elemental2_dom_Node__org_elemento_By(element.m_element__(), selector);
 }
 /**
  * @template E
  * @param {Element} element
  ...
  * @public
  */
 static m_closest__elemental2_dom_Element__org_elemento_By(element, selector) {
  Elements.$clinit();
  return /**@type {E} */ ($Casts.$to(Js.m_cast__java_lang_Object(element.closest(selector.m_selector___$pp_org_elemento())), HTMLElement_$Overlay));
 }
 /**
  * @template E, F
  * @param {IsElement<E>} element
  ...
  * @public
  */
 static m_closest__org_elemento_IsElement__org_elemento_By(element, selector) {
  Elements.$clinit();
  return /**@type {F} */ ($Casts.$to(Js.m_cast__java_lang_Object(/**@type {HTMLElement} */ (element.m_element__()).closest(selector.m_selector___$pp_org_elemento())), HTMLElement_$Overlay));
 }
 /**
  * @template E
  ...
  * @public
  */
 static m_iterator__org_elemento_IsElement(parent) {
  Elements.$clinit();
  ...
  * @public
  */
 static m_children__org_elemento_IsElement(parent) {
  Elements.$clinit();
  return Iterable.$adapt(() =>{
   return Elements.m_iterator__org_elemento_IsElement(parent);
  });
 }
 /**
  * @template T
  ...
  * @public
  */
 static m_stream__org_elemento_IsElement(parent) {
  Elements.$clinit();
  if ($Equality.$same(parent, null)) {
   return /**@type {Stream<HTMLElement>} */ (Stream.m_empty__());
  } else {
   return /**@type {Stream<HTMLElement>} */ (StreamSupport.m_stream__java_util_Spliterator__boolean(/**@type {Spliterator<HTMLElement>} */ (Spliterators.m_spliteratorUnknownSize__java_util_Iterator__int(Elements.m_iterator__org_elemento_IsElement(parent), 0)), false));
  }
 }
 /**
  ...
  * @public
  */
 static m_lazyAppend__elemental2_dom_Element__org_elemento_IsElement(parent, child) {
  Elements.$clinit();
  ...
  * @public
  */
 static m_insertAfter__org_elemento_IsElement__elemental2_dom_Element(newElement, after) {
  Elements.$clinit();
  ...
  * @public
  */
 static m_lazyInsertAfter__org_elemento_IsElement__elemental2_dom_Element(newElement, after) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null)) {
  ...
  * @public
  */
 static m_lazyInsertAfter__elemental2_dom_Element__org_elemento_IsElement__elemental2_dom_Element(parent, newElement, after) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null)) {
  ...
  * @public
  */
 static m_insertBefore__org_elemento_IsElement__elemental2_dom_Element(newElement, before) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null)) {
  ...
  * @public
  */
 static m_lazyInsertBefore__org_elemento_IsElement__elemental2_dom_Element(newElement, before) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null)) {
  ...
  * @public
  */
 static m_lazyInsertBefore__elemental2_dom_Element__org_elemento_IsElement__elemental2_dom_Element(parent, newElement, before) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null)) {
  ...
  * @public
  */
 static m_insertFirst__elemental2_dom_Element__org_elemento_IsElement(parent, newElement) {
  Elements.$clinit();
  if (!$Equality.$same(newElement, null)) {
  ...
  * @public
  */
 static m_removeChildrenFrom__org_elemento_IsElement(element) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
  ...
  * @public
  */
 static m_failSafeRemoveFromParent__org_elemento_IsElement(element) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
  ...
  * @public
  */
 static m_failSafeRemove__elemental2_dom_Node__org_elemento_IsElement(parent, child) {
  Elements.$clinit();
  if (!$Equality.$same(child, null)) {
  ...
  * @public
  */
 static m_onAttach__elemental2_dom_HTMLElement__org_elemento_ObserverCallback(element, callback) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   BodyObserver.m_addAttachObserver__elemental2_dom_HTMLElement__org_elemento_ObserverCallback(element, callback);
  }
 }
 /**
  * @template E
  ...
  * @public
  */
 static m_onAttach__org_elemento_IsElement__org_elemento_ObserverCallback(element, callback) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   Elements.m_onAttach__elemental2_dom_HTMLElement__org_elemento_ObserverCallback(element.m_element__(), callback);
  }
 }
 /**
  * @param {HTMLElement} element
  ...
  * @public
  */
 static m_onDetach__elemental2_dom_HTMLElement__org_elemento_ObserverCallback(element, callback) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   BodyObserver.m_addDetachObserver__elemental2_dom_HTMLElement__org_elemento_ObserverCallback(element, callback);
  }
 }
 /**
  * @template E
  ...
  * @public
  */
 static m_onDetach__org_elemento_IsElement__org_elemento_ObserverCallback(element, callback) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
   Elements.m_onDetach__elemental2_dom_HTMLElement__org_elemento_ObserverCallback(element.m_element__(), callback);
  }
 }
 /**
  * @return {?string}
 ...
 static m_uniqueId__() {
  ...
  let /** ?string */ id;
  do {
   id = j_l_String.m_valueOf__java_lang_Object(Elements.f_UNIQUE_ID__org_elemento_Elements_) + Elements.f_counter__org_elemento_Elements_;
   Elements.f_counter__org_elemento_Elements_++;
  ...
  * @public
  */
 static m_isVisible__org_elemento_IsElement(element) {
  Elements.$clinit();
  ...
  * @public
  */
 static m_setVisible__org_elemento_IsElement__boolean(element, visible) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
  ...
  * @public
  */
 static m_toggle__org_elemento_IsElement__java_lang_String__boolean(element, css, condition) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
  ...
  * @public
  */
 static m_toggle__org_elemento_IsElement__java_lang_String__java_util_function_Supplier(element, css, condition) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
  ...
  * @public
  */
 static m_innerHtml__org_elemento_IsElement__org_gwtproject_safehtml_shared_SafeHtml(element, html) {
  Elements.$clinit();
  if (!$Equality.$same(element, null)) {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_elemento_Elements__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_elemento_Elements__() {
  ...
  * @public
  */
 static get f_createElement__org_elemento_Elements() {
  return (Elements.$clinit(), Elements.$f_createElement__org_elemento_Elements);
 }
 /**
  * @param {ElementCreator} value
  * @public
  */
 static set f_createElement__org_elemento_Elements(value) {
  (Elements.$clinit(), Elements.$f_createElement__org_elemento_Elements = value);
 }
 /**
  * @public
  */
 static $clinit() {
  ...
  j_l_Object.$clinit();
  Elements.f_counter__org_elemento_Elements_ = 0;
  Elements.$f_createElement__org_elemento_Elements = $1.$create__();
 }
 /**
  * @param {?} instance
  * @return {boolean}
 ...
 static $loadModules() {
  ...
  BodyObserver = goog.module.get('org.elemento.BodyObserver$impl');
  $1 = goog.module.get('org.elemento.Elements.$1$impl');
  AsHTMLElement = goog.module.get('org.elemento.Elements.AsHTMLElement$impl');
  FilterHTMLElements = goog.module.get('org.elemento.Elements.FilterHTMLElements$impl');
  JsArrayElementIterator = goog.module.get('org.elemento.Elements.JsArrayElementIterator$impl');
  JsArrayLikeIterator = goog.module.get('org.elemento.Elements.JsArrayLikeIterator$impl');
  JsArrayNodeIterator = goog.module.get('org.elemento.Elements.JsArrayNodeIterator$impl');
  ElementsBag = goog.module.get('org.elemento.ElementsBag$impl');
  EmptyContentBuilder = goog.module.get('org.elemento.EmptyContentBuilder$impl');
  ...
  TextContentBuilder = goog.module.get('org.elemento.TextContentBuilder$impl');
...
$Util.$setClassMetadata(Elements, 'org.elemento.Elements');

/** @public {?string} @const */
Elements.f_UNIQUE_ID__org_elemento_Elements_ = "id-";
/** @public {number} */
Elements.f_counter__org_elemento_Elements_ = 0;
/** @private {ElementCreator} */
Elements.$f_createElement__org_elemento_Elements;
