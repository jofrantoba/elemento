goog.module('org.elemento.Elements.JsArrayLikeIterator$impl');
...
class JsArrayLikeIterator extends j_l_Object {
 ...
 constructor() {
  super();
  /** @public {IArrayLike<?>} */
  this.f_data__org_elemento_Elements_JsArrayLikeIterator_;
  /** @public {number} */
  this.f_pos__org_elemento_Elements_JsArrayLikeIterator_ = 0;
 }
 /**
  * @template T
 ...
 static $create__jsinterop_base_JsArrayLike(nodes) {
  ...
  $instance.$ctor__org_elemento_Elements_JsArrayLikeIterator__jsinterop_base_JsArrayLike(nodes);
  return $instance;
 }
 /**
  * @param {IArrayLike<?>} nodes
  * @public
  */
 $ctor__org_elemento_Elements_JsArrayLikeIterator__jsinterop_base_JsArrayLike(nodes) {
  this.$ctor__java_lang_Object__();
  this.$init___$p_org_elemento_Elements_JsArrayLikeIterator();
  this.f_data__org_elemento_Elements_JsArrayLikeIterator_ = nodes;
 }
 /**
  * @override
  * @return {boolean}
  ...
  */
 m_hasNext__() {
  return this.f_pos__org_elemento_Elements_JsArrayLikeIterator_ < $Overlay.m_getLength__$devirt__jsinterop_base_JsArrayLike(this.f_data__org_elemento_Elements_JsArrayLikeIterator_);
 }
 /**
  * @override
  * @return {T}
 ...
 m_next__() {
  ...
  return $Overlay.m_getAt__$devirt__jsinterop_base_JsArrayLike__int(this.f_data__org_elemento_Elements_JsArrayLikeIterator_, this.f_pos__org_elemento_Elements_JsArrayLikeIterator_++);
 }
 /**
  ...
  * @private
  */
 $init___$p_org_elemento_Elements_JsArrayLikeIterator() {
  this.f_pos__org_elemento_Elements_JsArrayLikeIterator_ = 0;
 }
 /**
  * @public
...
$Util.$setClassMetadata(JsArrayLikeIterator, 'org.elemento.Elements$JsArrayLikeIterator');
