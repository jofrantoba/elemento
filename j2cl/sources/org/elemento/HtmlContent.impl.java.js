goog.module('org.elemento.HtmlContent$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const TextContent = goog.require('org.elemento.TextContent$impl');
...
let TypedBuilder = goog.forwardDeclare('org.elemento.TypedBuilder$impl');
...
class HtmlContent {
  ...
  * @public
  */
 static m_innerHtml__$default__org_elemento_HtmlContent__org_gwtproject_safehtml_shared_SafeHtml($thisArg, html) {
  HtmlContent.$clinit();
  ...
  * @public
  */
 static m_add__$default__org_elemento_HtmlContent__java_lang_String($thisArg, text) {
  HtmlContent.$clinit();
  ...
  * @public
  */
 static m_add__$default__org_elemento_HtmlContent__elemental2_dom_Node($thisArg, element) {
  HtmlContent.$clinit();
  ...
  * @public
  */
 static m_add__$default__org_elemento_HtmlContent__org_elemento_IsElement($thisArg, element) {
  HtmlContent.$clinit();
  ...
  * @public
  */
 static m_addAll__$default__org_elemento_HtmlContent__arrayOf_elemental2_dom_Node($thisArg, nodes) {
  HtmlContent.$clinit();
  ...
  * @public
  */
 static m_addAll__$default__org_elemento_HtmlContent__arrayOf_elemental2_dom_Element($thisArg, elements) {
  HtmlContent.$clinit();
  ...
  * @public
  */
 static m_addAll__$default__org_elemento_HtmlContent__arrayOf_elemental2_dom_HTMLElement($thisArg, elements) {
  HtmlContent.$clinit();
  for (let $array = elements, $index = 0; $index < $array.length; $index++) {
   let element = $array[$index];
   $thisArg.m_add__elemental2_dom_Node(element);
  ...
  * @public
  */
 static m_addAll__$default__org_elemento_HtmlContent__arrayOf_org_elemento_IsElement($thisArg, elements) {
  HtmlContent.$clinit();
  for (let $array = elements, $index = 0; $index < $array.length; $index++) {
   let element = $array[$index];
   if (!$Equality.$same(element, null)) {
  ...
  * @public
  */
 static m_addAll__$default__org_elemento_HtmlContent__java_lang_Iterable($thisArg, elements) {
  HtmlContent.$clinit();
 ...
 static $markImplementor(classConstructor) {
   ...
   * @public {boolean}
   */
  classConstructor.prototype.$implements__org_elemento_HtmlContent = true;
 }
 /**
  * @param {?} instance
  * @return {boolean}
 ...
 static $isInstance(instance) {
  return instance != null && !!instance.$implements__org_elemento_HtmlContent;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadataForInterface(HtmlContent, 'org.elemento.HtmlContent');
