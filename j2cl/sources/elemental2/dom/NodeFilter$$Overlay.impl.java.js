...
class $Overlay {
 ...
 static $clinit() {
  $Overlay.$clinit = () =>{};
  $Overlay.$loadModules();
  $Overlay.$f_FILTER_ACCEPT__elemental2_dom_NodeFilter_$Overlay = NodeFilter.FILTER_ACCEPT;
  $Overlay.$f_FILTER_REJECT__elemental2_dom_NodeFilter_$Overlay = NodeFilter.FILTER_REJECT;
  $Overlay.$f_FILTER_SKIP__elemental2_dom_NodeFilter_$Overlay = NodeFilter.FILTER_SKIP;
  $Overlay.$f_SHOW_ALL__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_ALL;
  $Overlay.$f_SHOW_ATTRIBUTE__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_ATTRIBUTE;
  $Overlay.$f_SHOW_CDATA_SECTION__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_CDATA_SECTION;
  $Overlay.$f_SHOW_COMMENT__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_COMMENT;
  $Overlay.$f_SHOW_DOCUMENT__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_DOCUMENT;
  $Overlay.$f_SHOW_DOCUMENT_FRAGMENT__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_DOCUMENT_FRAGMENT;
  $Overlay.$f_SHOW_DOCUMENT_TYPE__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_DOCUMENT_TYPE;
  $Overlay.$f_SHOW_ELEMENT__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_ELEMENT;
  $Overlay.$f_SHOW_ENTITY__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_ENTITY;
  $Overlay.$f_SHOW_ENTITY_REFERENCE__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_ENTITY_REFERENCE;
  $Overlay.$f_SHOW_NOTATION__elemental2_dom_NodeFilter_$Overlay = NodeFilter.SHOW_NOTATION;
