goog.module('org.elemento.EmptyContentBuilder$impl');
...
class EmptyContentBuilder extends ElementBuilder {
 ...
 static $create__elemental2_dom_HTMLElement(element) {
  ...
  $instance.$ctor__org_elemento_EmptyContentBuilder__elemental2_dom_HTMLElement(element);
  return $instance;
 }
 /**
  * @param {E} element
  * @public
  */
 $ctor__org_elemento_EmptyContentBuilder__elemental2_dom_HTMLElement(element) {
...
$Util.$setClassMetadata(EmptyContentBuilder, 'org.elemento.EmptyContentBuilder');
