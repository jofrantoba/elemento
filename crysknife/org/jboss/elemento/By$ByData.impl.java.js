...
class ByData extends ByAttribute {
  ...
  * @public
  */
 static $create__java_lang_String__org_jboss_elemento_By_AttributeOperator__java_lang_String(name, attributeOperator, value) {
  ByData.$clinit();
  ...
  * @public
  */
 $ctor__org_jboss_elemento_By_ByData__java_lang_String__org_jboss_elemento_By_AttributeOperator__java_lang_String(name, attributeOperator, value) {
