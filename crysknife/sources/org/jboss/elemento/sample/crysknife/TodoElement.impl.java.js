...
class TodoElement extends j_l_Object {
 ...
 constructor() {
  ...
  /** @public {HTMLInputElement} */
  this.f_summary__org_jboss_elemento_sample_crysknife_TodoElement_;
  ...
  * @public
  */
 static $create__org_jboss_elemento_sample_crysknife_ApplicationElement__org_jboss_elemento_sample_crysknife_TodoRepository__org_jboss_elemento_sample_crysknife_Todo(application, repository, item) {
  TodoElement.$clinit();
  ...
  * @public
  */
 $ctor__org_jboss_elemento_sample_crysknife_TodoElement__org_jboss_elemento_sample_crysknife_ApplicationElement__org_jboss_elemento_sample_crysknife_TodoRepository__org_jboss_elemento_sample_crysknife_Todo(application, repository, item) {
 ...
 m_attach__elemental2_dom_MutationRecord(mutationRecord) {
  ...
  }), EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn(this.f_summary__org_jboss_elemento_sample_crysknife_TodoElement_, EventType.f_keydown__org_jboss_elemento_EventType, (arg0) =>{
  ...
  }), EventType.m_bind__elemental2_dom_EventTarget__org_jboss_elemento_EventType__org_jboss_elemento_EventCallbackFn(this.f_summary__org_jboss_elemento_sample_crysknife_TodoElement_, EventType.f_blur__org_jboss_elemento_EventType, (ev_5) =>{
 ...
 m_edit___$p_org_jboss_elemento_sample_crysknife_TodoElement() {
  ...
  this.f_summary__org_jboss_elemento_sample_crysknife_TodoElement_.value = this.f_label__org_jboss_elemento_sample_crysknife_TodoElement_.textContent;
  this.f_summary__org_jboss_elemento_sample_crysknife_TodoElement_.focus();
 }
 /**
  * @public
  */
  ...
  * @public
  */
 m_keyDown__elemental2_dom_KeyboardEvent_$p_org_jboss_elemento_sample_crysknife_TodoElement(event) {
 ...
 m_blur___$p_org_jboss_elemento_sample_crysknife_TodoElement() {
  let value = j_l_String.m_trim__java_lang_String(this.f_summary__org_jboss_elemento_sample_crysknife_TodoElement_.value);
