...
class $Overlay {
 ...
 static $clinit() {
  $Overlay.$clinit = () =>{};
  $Overlay.$loadModules();
  $Overlay.$f_ATTRIBUTE_NODE__elemental2_dom_Node_$Overlay = Node.ATTRIBUTE_NODE;
  $Overlay.$f_CDATA_SECTION_NODE__elemental2_dom_Node_$Overlay = Node.CDATA_SECTION_NODE;
  $Overlay.$f_COMMENT_NODE__elemental2_dom_Node_$Overlay = Node.COMMENT_NODE;
  $Overlay.$f_DOCUMENT_FRAGMENT_NODE__elemental2_dom_Node_$Overlay = Node.DOCUMENT_FRAGMENT_NODE;
  $Overlay.$f_DOCUMENT_NODE__elemental2_dom_Node_$Overlay = Node.DOCUMENT_NODE;
  $Overlay.$f_DOCUMENT_POSITION_CONTAINED_BY__elemental2_dom_Node_$Overlay = Node.DOCUMENT_POSITION_CONTAINED_BY;
  $Overlay.$f_DOCUMENT_POSITION_CONTAINS__elemental2_dom_Node_$Overlay = Node.DOCUMENT_POSITION_CONTAINS;
  $Overlay.$f_DOCUMENT_POSITION_DISCONNECTED__elemental2_dom_Node_$Overlay = Node.DOCUMENT_POSITION_DISCONNECTED;
  $Overlay.$f_DOCUMENT_POSITION_FOLLOWING__elemental2_dom_Node_$Overlay = Node.DOCUMENT_POSITION_FOLLOWING;
  $Overlay.$f_DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC__elemental2_dom_Node_$Overlay = Node.DOCUMENT_POSITION_IMPLEMENTATION_SPECIFIC;
  $Overlay.$f_DOCUMENT_POSITION_PRECEDING__elemental2_dom_Node_$Overlay = Node.DOCUMENT_POSITION_PRECEDING;
  $Overlay.$f_DOCUMENT_TYPE_NODE__elemental2_dom_Node_$Overlay = Node.DOCUMENT_TYPE_NODE;
  $Overlay.$f_ELEMENT_NODE__elemental2_dom_Node_$Overlay = Node.ELEMENT_NODE;
  $Overlay.$f_ENTITY_NODE__elemental2_dom_Node_$Overlay = Node.ENTITY_NODE;
  $Overlay.$f_ENTITY_REFERENCE_NODE__elemental2_dom_Node_$Overlay = Node.ENTITY_REFERENCE_NODE;
  $Overlay.$f_NOTATION_NODE__elemental2_dom_Node_$Overlay = Node.NOTATION_NODE;
