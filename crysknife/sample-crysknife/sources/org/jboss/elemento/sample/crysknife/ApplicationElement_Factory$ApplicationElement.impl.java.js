...
class ApplicationElement__Factory_ApplicationElement extends ApplicationElement {
 ...
 constructor() {
  super();
  /** @public {ApplicationElement__Factory} */
 ...
 /**
  * @param {ApplicationElement__Factory} $outer_this
  * @param {TodoRepository} repository
  * @return {!ApplicationElement__Factory_ApplicationElement}
  * @public
  */
 static $create__org_jboss_elemento_sample_crysknife_ApplicationElement_Factory__org_jboss_elemento_sample_crysknife_TodoRepository($outer_this, repository) {
  ...
  * @public
  */
 $ctor__org_jboss_elemento_sample_crysknife_ApplicationElement_Factory_ApplicationElement__org_jboss_elemento_sample_crysknife_ApplicationElement_Factory__org_jboss_elemento_sample_crysknife_TodoRepository($outer_this, repository) {
