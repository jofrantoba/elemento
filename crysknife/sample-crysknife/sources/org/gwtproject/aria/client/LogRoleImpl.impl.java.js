goog.module('org.gwtproject.aria.client.LogRoleImpl$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const LogRole = goog.require('org.gwtproject.aria.client.LogRole$impl');
 ...
 * @implements {LogRole}
  */
class LogRoleImpl extends RoleImpl {
 /** @protected */
 constructor() {
  super();
 }
 ...
 static $create__java_lang_String(/** ?string */ roleName) {
  LogRoleImpl.$clinit();
  let $instance = new LogRoleImpl();
  $instance.$ctor__org_gwtproject_aria_client_LogRoleImpl__java_lang_String(roleName);
  return $instance;
 }
 
 $ctor__org_gwtproject_aria_client_LogRoleImpl__java_lang_String(/** ?string */ roleName) {
 ...
 static $clinit() {
  LogRoleImpl.$clinit = () =>{};
  LogRoleImpl.$loadModules();
  RoleImpl.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LogRoleImpl;
 }
...
$Util.$setClassMetadata(LogRoleImpl, 'org.gwtproject.aria.client.LogRoleImpl');

LogRole.$markImplementor(LogRoleImpl);

exports = LogRoleImpl; 
//# sourceMappingURL=LogRoleImpl.js.map