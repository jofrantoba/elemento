goog.module('org.gwtproject.aria.client.ArticleRoleImpl$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const ArticleRole = goog.require('org.gwtproject.aria.client.ArticleRole$impl');
 ...
 * @implements {ArticleRole}
  */
class ArticleRoleImpl extends RoleImpl {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!ArticleRoleImpl} */
 static $create__java_lang_String(/** ?string */ roleName) {
  ArticleRoleImpl.$clinit();
  let $instance = new ArticleRoleImpl();
  $instance.$ctor__org_gwtproject_aria_client_ArticleRoleImpl__java_lang_String(roleName);
  return $instance;
 }
 
 $ctor__org_gwtproject_aria_client_ArticleRoleImpl__java_lang_String(/** ?string */ roleName) {
 ...
 static $clinit() {
  ArticleRoleImpl.$clinit = () =>{};
  ArticleRoleImpl.$loadModules();
  RoleImpl.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof ArticleRoleImpl;
 }
...
$Util.$setClassMetadata(ArticleRoleImpl, 'org.gwtproject.aria.client.ArticleRoleImpl');

ArticleRole.$markImplementor(ArticleRoleImpl);

exports = ArticleRoleImpl; 
//# sourceMappingURL=ArticleRoleImpl.js.map