goog.module('org.gwtproject.aria.client.MarqueeRoleImpl$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const MarqueeRole = goog.require('org.gwtproject.aria.client.MarqueeRole$impl');
 ...
 * @implements {MarqueeRole}
  */
class MarqueeRoleImpl extends RoleImpl {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!MarqueeRoleImpl} */
 static $create__java_lang_String(/** ?string */ roleName) {
  MarqueeRoleImpl.$clinit();
  let $instance = new MarqueeRoleImpl();
  $instance.$ctor__org_gwtproject_aria_client_MarqueeRoleImpl__java_lang_String(roleName);
  return $instance;
 }
 
 $ctor__org_gwtproject_aria_client_MarqueeRoleImpl__java_lang_String(/** ?string */ roleName) {
 ...
 static $clinit() {
  MarqueeRoleImpl.$clinit = () =>{};
  MarqueeRoleImpl.$loadModules();
  RoleImpl.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof MarqueeRoleImpl;
 }
...
$Util.$setClassMetadata(MarqueeRoleImpl, 'org.gwtproject.aria.client.MarqueeRoleImpl');

MarqueeRole.$markImplementor(MarqueeRoleImpl);

exports = MarqueeRoleImpl; 
//# sourceMappingURL=MarqueeRoleImpl.js.map