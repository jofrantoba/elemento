...
class $LambdaAdaptor extends j_l_Object {
 ...
 $ctor__org_gwtproject_cell_client_ImageCell_Template_$LambdaAdaptor__org_gwtproject_cell_client_ImageCell_Template_$JsFunction(/** ?function(?string):SafeHtml */ fn) {
