...
class $LambdaAdaptor extends j_l_Object {
  ...
  * @public
  */
 $ctor__org_gwtproject_safecss_shared_annotations_VisibleForTesting_$LambdaAdaptor__org_gwtproject_safecss_shared_annotations_VisibleForTesting_$JsFunction(fn) {
