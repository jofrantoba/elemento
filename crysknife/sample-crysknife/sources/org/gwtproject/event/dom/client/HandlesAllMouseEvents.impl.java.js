...
class HandlesAllMouseEvents extends j_l_Object {
 ...
 /**
  * @param {HasAllMouseHandlers} eventSource
  * @public
  */
 m_handle__org_gwtproject_event_dom_client_HasAllMouseHandlers(eventSource) {
 ...
 /**
  * @template H
  * @param {HasAllMouseHandlers} source
  * @param {H} reciever
  * @public
  */
 static m_handle__org_gwtproject_event_dom_client_HasAllMouseHandlers__org_gwtproject_event_dom_client_MouseDownHandler(source, reciever) {
