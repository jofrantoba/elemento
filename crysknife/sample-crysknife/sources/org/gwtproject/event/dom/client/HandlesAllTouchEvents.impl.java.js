...
class HandlesAllTouchEvents extends j_l_Object {
 ...
 /**
  * @param {HasAllTouchHandlers} eventSource
  * @public
  */
 m_handle__org_gwtproject_event_dom_client_HasAllTouchHandlers(eventSource) {
 ...
 /**
  * @template H
  * @param {HasAllTouchHandlers} source
  * @param {H} reciever
  * @public
  */
 static m_handle__org_gwtproject_event_dom_client_HasAllTouchHandlers__org_gwtproject_event_dom_client_TouchStartHandler(source, reciever) {
