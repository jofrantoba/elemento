...
class DomEvent_Type extends Type {
  ...
  * @param {DomEvent<H>} flyweight
  * @return {!DomEvent_Type<H>}
  * @public
  */
 static $create__java_lang_String__org_gwtproject_event_dom_client_DomEvent(eventName, flyweight) {
  ...
  * @public
  */
 $ctor__org_gwtproject_event_dom_client_DomEvent_Type__java_lang_String__org_gwtproject_event_dom_client_DomEvent(eventName, flyweight) {
