...
class DataGrid__ResourcesImpl extends j_l_Object {
 ...
 /**
  * @param {DataGrid__ResourcesImpl} value
  * @public
  */
 static set f__instance0__org_gwtproject_user_cellview_client_DataGrid_ResourcesImpl_(value) {
  ...
  * @public
  */
 static set f_dataGridLoading__org_gwtproject_user_cellview_client_DataGrid_ResourcesImpl_(value) {
  ...
  * @public
  */
 static set f_dataGridSortAscending__org_gwtproject_user_cellview_client_DataGrid_ResourcesImpl_(value) {
  ...
  * @public
  */
 static set f_dataGridSortDescending__org_gwtproject_user_cellview_client_DataGrid_ResourcesImpl_(value) {
  ...
  * @public
  */
 static set f_dataGridStyle__org_gwtproject_user_cellview_client_DataGrid_ResourcesImpl_(value) {
