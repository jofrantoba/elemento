...
class $1 extends j_l_Object {
 ...
 constructor() {
  super();
  /** @public {CellTree__BasicResourcesImpl} */
 ...
 /**
  * @param {CellTree__BasicResourcesImpl} $outer_this
  * @return {!$1}
  * @public
  */
 static $create__org_gwtproject_user_cellview_client_CellTree_BasicResourcesImpl($outer_this) {
  $1.$clinit();
  let $instance = new $1();
  ...
  * @public
  */
 $ctor__org_gwtproject_user_cellview_client_CellTree_BasicResourcesImpl_1__org_gwtproject_user_cellview_client_CellTree_BasicResourcesImpl($outer_this) {
