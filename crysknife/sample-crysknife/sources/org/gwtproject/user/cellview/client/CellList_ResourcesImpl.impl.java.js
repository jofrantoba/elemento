...
class CellList__ResourcesImpl extends j_l_Object {
 ...
 /**
  * @param {CellList__ResourcesImpl} value
  * @public
  */
 static set f__instance0__org_gwtproject_user_cellview_client_CellList_ResourcesImpl_(value) {
  ...
  * @public
  */
 static set f_cellListSelectedBackground__org_gwtproject_user_cellview_client_CellList_ResourcesImpl_(value) {
  ...
  * @public
  */
 static set f_cellListStyle__org_gwtproject_user_cellview_client_CellList_ResourcesImpl_(value) {
