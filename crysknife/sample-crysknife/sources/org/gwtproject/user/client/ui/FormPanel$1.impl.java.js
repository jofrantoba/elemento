...
class $1 extends j_l_Object {
 ...
 /** @return {!$1} */
 static $create__org_gwtproject_user_client_ui_FormPanel(/** FormPanel */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
 ...
 $ctor__org_gwtproject_user_client_ui_FormPanel_1__org_gwtproject_user_client_ui_FormPanel(/** FormPanel */ $outer_this) {
