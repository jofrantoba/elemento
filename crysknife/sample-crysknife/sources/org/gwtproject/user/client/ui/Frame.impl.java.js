...
class Frame extends Widget {
 ...
 $ctor__org_gwtproject_user_client_ui_Frame__java_lang_String(/** ?string */ url) {
 ...
 $ctor__org_gwtproject_user_client_ui_Frame__org_gwtproject_dom_client_Element(/** Object */ element) {
  this.$ctor__org_gwtproject_user_client_ui_Widget__();
