...
class $1 extends j_l_Object {
 ...
 /** @return {!$1} */
 static $create__org_gwtproject_user_client_ui_Image_State__org_gwtproject_user_client_ui_Image(/** State */ $outer_this, /** Image */ $c_image) {
  $1.$clinit();
  let $instance = new $1();
 ...
 $ctor__org_gwtproject_user_client_ui_Image_State_1__org_gwtproject_user_client_ui_Image_State__org_gwtproject_user_client_ui_Image(/** State */ $outer_this, /** Image */ $c_image) {
