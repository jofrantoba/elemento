...
class InlineHTML extends HTML {
 ...
 $ctor__org_gwtproject_user_client_ui_InlineHTML__org_gwtproject_safehtml_shared_SafeHtml(/** SafeHtml */ html) {
 ...
 $ctor__org_gwtproject_user_client_ui_InlineHTML__org_gwtproject_safehtml_shared_SafeHtml__org_gwtproject_i18n_client_HasDirection_Direction(/** SafeHtml */ html, /** Direction */ dir) {
 ...
 $ctor__org_gwtproject_user_client_ui_InlineHTML__org_gwtproject_safehtml_shared_SafeHtml__org_gwtproject_i18n_shared_DirectionEstimator(/** SafeHtml */ html, /** DirectionEstimator */ directionEstimator) {
 ...
 $ctor__org_gwtproject_user_client_ui_InlineHTML__java_lang_String(/** ?string */ html) {
  this.$ctor__org_gwtproject_user_client_ui_InlineHTML__();
 ...
 $ctor__org_gwtproject_user_client_ui_InlineHTML__java_lang_String__org_gwtproject_i18n_client_HasDirection_Direction(/** ?string */ html, /** Direction */ dir) {
  this.$ctor__org_gwtproject_user_client_ui_InlineHTML__();
 ...
 $ctor__org_gwtproject_user_client_ui_InlineHTML__org_gwtproject_dom_client_Element(/** Object */ element) {
