...
class $2 extends j_l_Object {
 ...
 /** @return {!$2} */
 static $create__org_gwtproject_user_client_ui_CustomScrollPanel__org_gwtproject_user_client_ui_VerticalScrollbar(/** CustomScrollPanel */ $outer_this, /** VerticalScrollbar */ $c_scrollbar) {
  $2.$clinit();
  let $instance = new $2();
 ...
 $ctor__org_gwtproject_user_client_ui_CustomScrollPanel_2__org_gwtproject_user_client_ui_CustomScrollPanel__org_gwtproject_user_client_ui_VerticalScrollbar(/** CustomScrollPanel */ $outer_this, /** VerticalScrollbar */ $c_scrollbar) {
