...
class $1 extends j_l_Object {
 ...
 constructor() {
  super();
  /** @public {NativeVerticalScrollbar__UiBinderBundleImpl} */
 ...
 /**
  * @param {NativeVerticalScrollbar__UiBinderBundleImpl} $outer_this
  * @return {!$1}
  * @public
  */
 static $create__org_gwtproject_user_client_ui_NativeVerticalScrollbar_UiBinderBundleImpl($outer_this) {
  $1.$clinit();
  let $instance = new $1();
  ...
  * @public
  */
 $ctor__org_gwtproject_user_client_ui_NativeVerticalScrollbar_UiBinderBundleImpl_1__org_gwtproject_user_client_ui_NativeVerticalScrollbar_UiBinderBundleImpl($outer_this) {
