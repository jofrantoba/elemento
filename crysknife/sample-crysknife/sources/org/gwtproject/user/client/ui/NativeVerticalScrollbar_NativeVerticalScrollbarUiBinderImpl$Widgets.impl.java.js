...
class Widgets extends j_l_Object {
 ...
 constructor() {
  super();
  /** @public {NativeVerticalScrollbar__NativeVerticalScrollbarUiBinderImpl} */
 ...
 /**
  * @param {NativeVerticalScrollbar__NativeVerticalScrollbarUiBinderImpl} $outer_this
  * @param {NativeVerticalScrollbar} owner
  * @return {!Widgets}
  * @public
  */
 static $create__org_gwtproject_user_client_ui_NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl__org_gwtproject_user_client_ui_NativeVerticalScrollbar($outer_this, owner) {
  Widgets.$clinit();
  ...
  * @public
  */
 $ctor__org_gwtproject_user_client_ui_NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl_Widgets__org_gwtproject_user_client_ui_NativeVerticalScrollbar_NativeVerticalScrollbarUiBinderImpl__org_gwtproject_user_client_ui_NativeVerticalScrollbar($outer_this, owner) {
