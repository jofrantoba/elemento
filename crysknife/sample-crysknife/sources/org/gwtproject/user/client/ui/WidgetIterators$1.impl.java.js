...
class $1 extends j_l_Object {
 ...
 /**
  * @param {Array<Widget>} $c_contained
  * @param {HasWidgets} $c_container
  * @return {!$1}
  * @public
  */
 static $create__arrayOf_org_gwtproject_user_client_ui_Widget__org_gwtproject_user_client_ui_HasWidgets($c_contained, $c_container) {
  $1.$clinit();
  let $instance = new $1();
  ...
  * @public
  */
 $ctor__org_gwtproject_user_client_ui_WidgetIterators_1__arrayOf_org_gwtproject_user_client_ui_Widget__org_gwtproject_user_client_ui_HasWidgets($c_contained, $c_container) {
