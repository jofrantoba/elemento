...
class Widgets extends j_l_Object {
 ...
 constructor() {
  super();
  /** @public {NotificationMole__BinderImpl} */
  ...
  /** @public {NotificationMole__BinderImpl__GenCss__style} */
 ...
 /**
  * @param {NotificationMole__BinderImpl} $outer_this
  * @param {NotificationMole} owner
  * @return {!Widgets}
  * @public
  */
 static $create__org_gwtproject_user_client_ui_NotificationMole_BinderImpl__org_gwtproject_user_client_ui_NotificationMole($outer_this, owner) {
  Widgets.$clinit();
  ...
  * @public
  */
 $ctor__org_gwtproject_user_client_ui_NotificationMole_BinderImpl_Widgets__org_gwtproject_user_client_ui_NotificationMole_BinderImpl__org_gwtproject_user_client_ui_NotificationMole($outer_this, owner) {
