...
class $1 extends j_l_Object {
 ...
 constructor() {
  super();
  /**@type {NativeVerticalScrollbar__ResourcesTransparantImpl}*/
 ...
 /** @return {!$1} */
 static $create__org_gwtproject_user_client_ui_NativeVerticalScrollbar_ResourcesTransparantImpl(/** NativeVerticalScrollbar__ResourcesTransparantImpl */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
 ...
 $ctor__org_gwtproject_user_client_ui_NativeVerticalScrollbar_ResourcesTransparantImpl_1__org_gwtproject_user_client_ui_NativeVerticalScrollbar_ResourcesTransparantImpl(/** NativeVerticalScrollbar__ResourcesTransparantImpl */ $outer_this) {
