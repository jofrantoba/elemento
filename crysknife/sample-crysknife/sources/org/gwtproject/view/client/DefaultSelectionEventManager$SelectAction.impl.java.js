...
class SelectAction extends Enum {
 ...
 $ctor__org_gwtproject_view_client_DefaultSelectionEventManager_SelectAction__java_lang_String__int(/** ?string */ $name, /** number */ $ordinal) {
