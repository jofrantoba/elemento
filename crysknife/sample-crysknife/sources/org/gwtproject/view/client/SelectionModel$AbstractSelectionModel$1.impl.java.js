...
class $1 extends j_l_Object {
 ...
 constructor() {
  super();
  /**@type {AbstractSelectionModel<T>}*/
  this.f_$outer_this__org_gwtproject_view_client_SelectionModel_AbstractSelectionModel_1;
 }
 /** @template T @return {!$1<T>} */
 static $create__org_gwtproject_view_client_SelectionModel_AbstractSelectionModel(/** AbstractSelectionModel<T> */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
 ...
 $ctor__org_gwtproject_view_client_SelectionModel_AbstractSelectionModel_1__org_gwtproject_view_client_SelectionModel_AbstractSelectionModel(/** AbstractSelectionModel<T> */ $outer_this) {
