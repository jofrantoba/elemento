...
class DomElementBuilderBase extends AbstractElementBuilderBase {
  ...
  * @return {!DomElementBuilderBase<R, E>}
  * @public
  */
  ...
  * @public
  */
 $ctor__org_gwtproject_dom_builder_client_DomElementBuilderBase__org_gwtproject_dom_builder_client_DomBuilderImpl(delegate) {
  ...
  * @public
  */
 static $create__org_gwtproject_dom_builder_client_DomBuilderImpl__boolean(delegate, isEndTagForbidden) {
  DomElementBuilderBase.$clinit();
  let $instance = new DomElementBuilderBase();
  ...
  * @public
  */
 $ctor__org_gwtproject_dom_builder_client_DomElementBuilderBase__org_gwtproject_dom_builder_client_DomBuilderImpl__boolean(delegate, isEndTagForbidden) {
