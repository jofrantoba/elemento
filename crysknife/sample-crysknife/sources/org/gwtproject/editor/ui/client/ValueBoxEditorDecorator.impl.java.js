...
class ValueBoxEditorDecorator extends Composite {
  ...
  * @template T
  * @return {!ValueBoxEditorDecorator<T>}
  * @public
  */
 static $create__() {
  ...
  * @template T
  * @param {ValueBoxBase<T>} widget
  * @param {ValueBoxEditor<T>} editor
  * @return {!ValueBoxEditorDecorator<T>}
  * @public
  */
 static $create__org_gwtproject_user_client_ui_ValueBoxBase__org_gwtproject_editor_ui_client_adapters_ValueBoxEditor(widget, editor) {
  ValueBoxEditorDecorator.$clinit();
  let $instance = new ValueBoxEditorDecorator();
  ...
  * @public
  */
 $ctor__org_gwtproject_editor_ui_client_ValueBoxEditorDecorator__org_gwtproject_user_client_ui_ValueBoxBase__org_gwtproject_editor_ui_client_adapters_ValueBoxEditor(widget, editor) {
  ...
  * @public
  */
 m_setEditor__org_gwtproject_editor_ui_client_adapters_ValueBoxEditor(editor) {
  this.f_editor__org_gwtproject_editor_ui_client_ValueBoxEditorDecorator_ = editor;
 }
 /**
  * @param {ValueBoxBase<T>} widget
  * @public
  */
 m_setValueBox__org_gwtproject_user_client_ui_ValueBoxBase(widget) {
  this.f_contents__org_gwtproject_editor_ui_client_ValueBoxEditorDecorator.m_add__org_gwtproject_user_client_ui_Widget(widget);
