goog.module('org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_fa_AF$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const DateTimeFormatInfoImpl__fa = goog.require('org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_fa$impl');
...
class DateTimeFormatInfoImpl__fa__AF extends DateTimeFormatInfoImpl__fa {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_fa_AF__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_fa_AF__() {
  this.$ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_fa__();
 }
 /**
  * @override
  * @return {Array<?string>}
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__fa__AF, 'org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_fa_AF');
