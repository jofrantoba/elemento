goog.module('org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_qu$impl');
...
class DateTimeFormatInfoImpl__qu extends DateTimeFormatInfoImpl {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!DateTimeFormatInfoImpl__qu} */
 static $create__() {
  DateTimeFormatInfoImpl__qu.$clinit();
  let $instance = new DateTimeFormatInfoImpl__qu();
  $instance.$ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_qu__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_qu__() {
 ...
 /** @override @return {Array<?string>} */
 m_erasFull__() {
  return /**@type {!Array<?string>}*/ ($Arrays.$init(["BCE", "d.C."], j_l_String));
 }
 /** @override @return {Array<?string>} */
 m_erasShort__() {
  return /**@type {!Array<?string>}*/ ($Arrays.$init(["BCE", "d.C."], j_l_String));
 ...
 /** @override @return {Array<?string>} */
 m_weekdaysShort__() {
  return /**@type {!Array<?string>}*/ ($Arrays.$init(["Dom", "Lun", "Mar", "Mi\u00E9", "Jue", "Vie", "Sab"], j_l_String));
 }
 
 static $clinit() {
  DateTimeFormatInfoImpl__qu.$clinit = () =>{};
  DateTimeFormatInfoImpl__qu.$loadModules();
  DateTimeFormatInfoImpl.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof DateTimeFormatInfoImpl__qu;
 }
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__qu, 'org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_qu');

exports = DateTimeFormatInfoImpl__qu; 
//# sourceMappingURL=DateTimeFormatInfoImpl_qu.js.map