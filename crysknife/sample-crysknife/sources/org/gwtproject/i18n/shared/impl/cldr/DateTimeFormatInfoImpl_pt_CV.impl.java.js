goog.module('org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_pt_CV$impl');
...
class DateTimeFormatInfoImpl__pt__CV extends DateTimeFormatInfoImpl__pt {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!DateTimeFormatInfoImpl__pt__CV}
  * @public
  */
 static $create__() {
  DateTimeFormatInfoImpl__pt__CV.$clinit();
  let $instance = new DateTimeFormatInfoImpl__pt__CV();
  $instance.$ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_pt_CV__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_pt_CV__() {
 ...
 static $clinit() {
  DateTimeFormatInfoImpl__pt__CV.$clinit = () =>{};
  DateTimeFormatInfoImpl__pt__CV.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof DateTimeFormatInfoImpl__pt__CV;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__pt__CV, 'org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_pt_CV');

exports = DateTimeFormatInfoImpl__pt__CV; 
//# sourceMappingURL=DateTimeFormatInfoImpl_pt_CV.js.map