goog.module('org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_az_Cyrl$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const DateTimeFormatInfoImpl__az = goog.require('org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_az$impl');
...
class DateTimeFormatInfoImpl__az__Cyrl extends DateTimeFormatInfoImpl__az {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_az_Cyrl__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_az_Cyrl__() {
  this.$ctor__org_gwtproject_i18n_shared_impl_cldr_DateTimeFormatInfoImpl_az__();
 }
 /**
  * @override
  * @return {Array<?string>}
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__az__Cyrl, 'org.gwtproject.i18n.shared.impl.cldr.DateTimeFormatInfoImpl_az_Cyrl');
