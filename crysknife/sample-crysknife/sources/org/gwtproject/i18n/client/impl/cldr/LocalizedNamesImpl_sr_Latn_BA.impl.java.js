goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_sr_Latn_BA$impl');
...
class LocalizedNamesImpl__sr__Latn__BA extends LocalizedNamesImpl__sr__Latn {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!LocalizedNamesImpl__sr__Latn__BA} */
 static $create__() {
  LocalizedNamesImpl__sr__Latn__BA.$clinit();
  let $instance = new LocalizedNamesImpl__sr__Latn__BA();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_sr_Latn_BA__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_sr_Latn_BA__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__sr__Latn__BA.$clinit = () =>{};
  LocalizedNamesImpl__sr__Latn__BA.$loadModules();
  LocalizedNamesImpl__sr__Latn.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LocalizedNamesImpl__sr__Latn__BA;
 }
...
$Util.$setClassMetadata(LocalizedNamesImpl__sr__Latn__BA, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_sr_Latn_BA');

exports = LocalizedNamesImpl__sr__Latn__BA; 
//# sourceMappingURL=LocalizedNamesImpl_sr_Latn_BA.js.map