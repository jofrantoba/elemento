goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_VE$impl');
...
class LocalizedNamesImpl__es__VE extends LocalizedNamesImpl__es__419 {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!LocalizedNamesImpl__es__VE} */
 static $create__() {
  LocalizedNamesImpl__es__VE.$clinit();
  let $instance = new LocalizedNamesImpl__es__VE();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_VE__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_VE__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__VE.$clinit = () =>{};
  LocalizedNamesImpl__es__VE.$loadModules();
  LocalizedNamesImpl__es__419.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LocalizedNamesImpl__es__VE;
 }
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__VE, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_VE');

exports = LocalizedNamesImpl__es__VE; 
//# sourceMappingURL=LocalizedNamesImpl_es_VE.js.map