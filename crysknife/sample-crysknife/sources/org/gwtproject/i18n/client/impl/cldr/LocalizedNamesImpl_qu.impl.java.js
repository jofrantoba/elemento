goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_qu$impl');
...
class LocalizedNamesImpl__qu extends LocalizedNamesImpl {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!LocalizedNamesImpl__qu}
  * @public
  */
 static $create__() {
  LocalizedNamesImpl__qu.$clinit();
  let $instance = new LocalizedNamesImpl__qu();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_qu__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_qu__() {
 ...
 m_loadLikelyRegionCodes__() {
  return /**@type {!Array<?string>} */ ($Arrays.$init(["PE", "BO"], j_l_String));
 }
 /**
  * @override
  * @return {Array<?string>}
 ...
 m_loadNameMap__() {
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("BQ", "Bonaire");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("CD", "Congo (RDC)");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("CX", "Isla Christmas");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("HK", "Hong Kong (RAE)");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("MK", "ERY Macedonia");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("MO", "Macao RAE");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("PS", "Palestina Kamachikuq");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("UM", "Islas menores alejadas de los EE.UU.");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("VA", "Santa Sede (Ciudad del Vaticano)");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("VI", "EE.UU. Islas V\u00EDrgenes");
 ...
 static $clinit() {
  LocalizedNamesImpl__qu.$clinit = () =>{};
  LocalizedNamesImpl__qu.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof LocalizedNamesImpl__qu;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(LocalizedNamesImpl__qu, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_qu');

exports = LocalizedNamesImpl__qu; 
//# sourceMappingURL=LocalizedNamesImpl_qu.js.map