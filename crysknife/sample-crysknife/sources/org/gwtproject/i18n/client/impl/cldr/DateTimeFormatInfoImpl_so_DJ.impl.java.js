goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_so_DJ$impl');
...
class DateTimeFormatInfoImpl__so__DJ extends DateTimeFormatInfoImpl__so {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_so_DJ__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_so_DJ__() {
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__so__DJ, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_so_DJ');
