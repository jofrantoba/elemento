goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_fr_CM$impl');
...
class DateTimeFormatInfoImpl__fr__CM extends DateTimeFormatInfoImpl__fr {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_fr_CM__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_fr_CM__() {
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__fr__CM, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_fr_CM');
