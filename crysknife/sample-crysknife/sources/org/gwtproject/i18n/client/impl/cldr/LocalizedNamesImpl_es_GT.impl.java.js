goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_GT$impl');
...
class LocalizedNamesImpl__es__GT extends LocalizedNamesImpl__es__419 {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!LocalizedNamesImpl__es__GT} */
 static $create__() {
  LocalizedNamesImpl__es__GT.$clinit();
  let $instance = new LocalizedNamesImpl__es__GT();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_GT__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_GT__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__GT.$clinit = () =>{};
  LocalizedNamesImpl__es__GT.$loadModules();
  LocalizedNamesImpl__es__419.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LocalizedNamesImpl__es__GT;
 }
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__GT, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_GT');

exports = LocalizedNamesImpl__es__GT; 
//# sourceMappingURL=LocalizedNamesImpl_es_GT.js.map