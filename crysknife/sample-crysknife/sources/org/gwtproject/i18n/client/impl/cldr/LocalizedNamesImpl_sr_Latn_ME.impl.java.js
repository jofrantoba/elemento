goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_sr_Latn_ME$impl');
...
class LocalizedNamesImpl__sr__Latn__ME extends LocalizedNamesImpl__sr__Latn {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!LocalizedNamesImpl__sr__Latn__ME}
  * @public
  */
 static $create__() {
  LocalizedNamesImpl__sr__Latn__ME.$clinit();
  let $instance = new LocalizedNamesImpl__sr__Latn__ME();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_sr_Latn_ME__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_sr_Latn_ME__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__sr__Latn__ME.$clinit = () =>{};
  LocalizedNamesImpl__sr__Latn__ME.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof LocalizedNamesImpl__sr__Latn__ME;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(LocalizedNamesImpl__sr__Latn__ME, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_sr_Latn_ME');

exports = LocalizedNamesImpl__sr__Latn__ME; 
//# sourceMappingURL=LocalizedNamesImpl_sr_Latn_ME.js.map