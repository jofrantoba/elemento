goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_pt_GW$impl');
...
class DateTimeFormatInfoImpl__pt__GW extends DateTimeFormatInfoImpl__pt {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!DateTimeFormatInfoImpl__pt__GW} */
 static $create__() {
  DateTimeFormatInfoImpl__pt__GW.$clinit();
  let $instance = new DateTimeFormatInfoImpl__pt__GW();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_pt_GW__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_pt_GW__() {
 ...
 static $clinit() {
  DateTimeFormatInfoImpl__pt__GW.$clinit = () =>{};
  DateTimeFormatInfoImpl__pt__GW.$loadModules();
  DateTimeFormatInfoImpl__pt.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof DateTimeFormatInfoImpl__pt__GW;
 }
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__pt__GW, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_pt_GW');

exports = DateTimeFormatInfoImpl__pt__GW; 
//# sourceMappingURL=DateTimeFormatInfoImpl_pt_GW.js.map