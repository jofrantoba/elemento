goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_EC$impl');
...
class LocalizedNamesImpl__es__EC extends LocalizedNamesImpl__es__419 {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!LocalizedNamesImpl__es__EC}
  * @public
  */
 static $create__() {
  LocalizedNamesImpl__es__EC.$clinit();
  let $instance = new LocalizedNamesImpl__es__EC();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_EC__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_EC__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__EC.$clinit = () =>{};
  LocalizedNamesImpl__es__EC.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof LocalizedNamesImpl__es__EC;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__EC, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_EC');

exports = LocalizedNamesImpl__es__EC; 
//# sourceMappingURL=LocalizedNamesImpl_es_EC.js.map