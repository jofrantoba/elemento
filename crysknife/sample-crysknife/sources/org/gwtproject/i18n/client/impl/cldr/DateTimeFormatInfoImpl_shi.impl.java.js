goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_shi$impl');
...
class DateTimeFormatInfoImpl__shi extends DateTimeFormatInfoImpl {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!DateTimeFormatInfoImpl__shi} */
 static $create__() {
  DateTimeFormatInfoImpl__shi.$clinit();
  let $instance = new DateTimeFormatInfoImpl__shi();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_shi__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_shi__() {
 ...
 /** @override @return {Array<?string>} */
 m_weekdaysFull__() {
  return /**@type {!Array<?string>}*/ ($Arrays.$init(["\u2D30\u2D59\u2D30\u2D4E\u2D30\u2D59", "\u2D30\u2D62\u2D4F\u2D30\u2D59", "\u2D30\u2D59\u2D49\u2D4F\u2D30\u2D59", "\u2D30\u2D3D\u2D55\u2D30\u2D59", "\u2D30\u2D3D\u2D61\u2D30\u2D59", "\u2D59\u2D49\u2D4E\u2D61\u2D30\u2D59", "\u2D30\u2D59\u2D49\u2D39\u2D62\u2D30\u2D59"], j_l_String));
 }
 /** @override @return {Array<?string>} */
 m_weekdaysShort__() {
 ...
 static $clinit() {
  DateTimeFormatInfoImpl__shi.$clinit = () =>{};
  DateTimeFormatInfoImpl__shi.$loadModules();
  DateTimeFormatInfoImpl.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof DateTimeFormatInfoImpl__shi;
 }
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__shi, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_shi');

exports = DateTimeFormatInfoImpl__shi; 
//# sourceMappingURL=DateTimeFormatInfoImpl_shi.js.map