goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_yo_BJ$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const DateTimeFormatInfoImpl__yo = goog.require('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_yo$impl');
...
class DateTimeFormatInfoImpl__yo__BJ extends DateTimeFormatInfoImpl__yo {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_yo_BJ__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_yo_BJ__() {
  this.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_yo__();
 }
 /**
  * @override
  * @return {Array<?string>}
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__yo__BJ, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_yo_BJ');
