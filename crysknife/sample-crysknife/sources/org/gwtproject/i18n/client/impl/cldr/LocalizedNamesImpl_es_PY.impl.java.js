goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_PY$impl');
...
class LocalizedNamesImpl__es__PY extends LocalizedNamesImpl__es__419 {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!LocalizedNamesImpl__es__PY}
  * @public
  */
 static $create__() {
  LocalizedNamesImpl__es__PY.$clinit();
  let $instance = new LocalizedNamesImpl__es__PY();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_PY__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_PY__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__PY.$clinit = () =>{};
  LocalizedNamesImpl__es__PY.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof LocalizedNamesImpl__es__PY;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__PY, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_PY');

exports = LocalizedNamesImpl__es__PY; 
//# sourceMappingURL=LocalizedNamesImpl_es_PY.js.map