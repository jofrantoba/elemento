goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ro_MD$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const DateTimeFormatInfoImpl__ro = goog.require('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ro$impl');
...
class DateTimeFormatInfoImpl__ro__MD extends DateTimeFormatInfoImpl__ro {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ro_MD__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ro_MD__() {
  this.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ro__();
 }
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__ro__MD, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ro_MD');
