goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_AR$impl');
...
class LocalizedNamesImpl__es__AR extends LocalizedNamesImpl__es__419 {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!LocalizedNamesImpl__es__AR} */
 static $create__() {
  LocalizedNamesImpl__es__AR.$clinit();
  let $instance = new LocalizedNamesImpl__es__AR();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_AR__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_AR__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__AR.$clinit = () =>{};
  LocalizedNamesImpl__es__AR.$loadModules();
  LocalizedNamesImpl__es__419.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LocalizedNamesImpl__es__AR;
 }
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__AR, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_AR');

exports = LocalizedNamesImpl__es__AR; 
//# sourceMappingURL=LocalizedNamesImpl_es_AR.js.map