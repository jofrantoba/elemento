goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ff_Latn_MR$impl');
...
class DateTimeFormatInfoImpl__ff__Latn__MR extends DateTimeFormatInfoImpl__ff {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ff_Latn_MR__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ff_Latn_MR__() {
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__ff__Latn__MR, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ff_Latn_MR');
