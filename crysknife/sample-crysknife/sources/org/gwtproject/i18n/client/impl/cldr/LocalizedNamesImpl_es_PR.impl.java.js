goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_PR$impl');
...
class LocalizedNamesImpl__es__PR extends LocalizedNamesImpl__es__419 {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!LocalizedNamesImpl__es__PR} */
 static $create__() {
  LocalizedNamesImpl__es__PR.$clinit();
  let $instance = new LocalizedNamesImpl__es__PR();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_PR__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_PR__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__PR.$clinit = () =>{};
  LocalizedNamesImpl__es__PR.$loadModules();
  LocalizedNamesImpl__es__419.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LocalizedNamesImpl__es__PR;
 }
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__PR, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_PR');

exports = LocalizedNamesImpl__es__PR; 
//# sourceMappingURL=LocalizedNamesImpl_es_PR.js.map