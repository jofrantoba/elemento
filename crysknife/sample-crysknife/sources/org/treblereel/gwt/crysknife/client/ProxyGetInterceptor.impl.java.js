...
class ProxyGetInterceptor extends j_l_Object {
 ...
 static m_addProperty__org_treblereel_gwt_crysknife_client_ProxyGetInterceptor__java_lang_String__java_util_function_BiFunction(/** function(*, ?string, *):* */ $thisArg, /** ?string */ obfuscated, /** BiFunction */ function_1) {
  ProxyGetInterceptor.$clinit();
 ...
 static m_addMethod__org_treblereel_gwt_crysknife_client_ProxyGetInterceptor__java_lang_String__java_util_function_BiFunction(/** function(*, ?string, *):* */ $thisArg, /** ?string */ obfuscated, /** BiFunction */ function_1) {
  ProxyGetInterceptor.$clinit();
