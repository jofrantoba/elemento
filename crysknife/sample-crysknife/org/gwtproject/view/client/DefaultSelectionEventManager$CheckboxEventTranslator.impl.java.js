...
class CheckboxEventTranslator extends j_l_Object {
  ...
  * @template T
  * @return {!CheckboxEventTranslator<T>}
  * @public
  */
 static $create__() {
  ...
  * @public
  */
 $ctor__org_gwtproject_view_client_DefaultSelectionEventManager_CheckboxEventTranslator__int(column) {
