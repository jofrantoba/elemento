goog.module('org.gwtproject.aria.client.ListRoleImpl$impl');
 ...
 * @implements {ListRole}
  */
class ListRoleImpl extends RoleImpl {
 /** @protected */
 constructor() {
  super();
 }
 ...
 static $create__java_lang_String(/** ?string */ roleName) {
  ListRoleImpl.$clinit();
  let $instance = new ListRoleImpl();
  $instance.$ctor__org_gwtproject_aria_client_ListRoleImpl__java_lang_String(roleName);
  return $instance;
 }
 
 $ctor__org_gwtproject_aria_client_ListRoleImpl__java_lang_String(/** ?string */ roleName) {
 ...
 static $clinit() {
  ListRoleImpl.$clinit = () =>{};
  ListRoleImpl.$loadModules();
  RoleImpl.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof ListRoleImpl;
 }
...
$Util.$setClassMetadata(ListRoleImpl, 'org.gwtproject.aria.client.ListRoleImpl');

ListRole.$markImplementor(ListRoleImpl);

exports = ListRoleImpl; 
//# sourceMappingURL=ListRoleImpl.js.map