goog.module('org.gwtproject.aria.client.RegionRoleImpl$impl');
 ...
 * @implements {RegionRole}
  */
class RegionRoleImpl extends RoleImpl {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!RegionRoleImpl} */
 static $create__java_lang_String(/** ?string */ roleName) {
  RegionRoleImpl.$clinit();
  let $instance = new RegionRoleImpl();
  $instance.$ctor__org_gwtproject_aria_client_RegionRoleImpl__java_lang_String(roleName);
  return $instance;
 }
 
 $ctor__org_gwtproject_aria_client_RegionRoleImpl__java_lang_String(/** ?string */ roleName) {
 ...
 static $clinit() {
  RegionRoleImpl.$clinit = () =>{};
  RegionRoleImpl.$loadModules();
  RoleImpl.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof RegionRoleImpl;
 }
...
$Util.$setClassMetadata(RegionRoleImpl, 'org.gwtproject.aria.client.RegionRoleImpl');

RegionRole.$markImplementor(RegionRoleImpl);

exports = RegionRoleImpl; 
//# sourceMappingURL=RegionRoleImpl.js.map