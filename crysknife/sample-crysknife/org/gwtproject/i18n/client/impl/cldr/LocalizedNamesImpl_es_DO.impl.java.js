goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_DO$impl');
...
class LocalizedNamesImpl__es__DO extends LocalizedNamesImpl__es__419 {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!LocalizedNamesImpl__es__DO}
  * @public
  */
 static $create__() {
  LocalizedNamesImpl__es__DO.$clinit();
  let $instance = new LocalizedNamesImpl__es__DO();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_DO__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_DO__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__DO.$clinit = () =>{};
  LocalizedNamesImpl__es__DO.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof LocalizedNamesImpl__es__DO;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__DO, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_DO');

exports = LocalizedNamesImpl__es__DO; 
//# sourceMappingURL=LocalizedNamesImpl_es_DO.js.map