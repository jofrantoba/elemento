goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ses$impl');
...
class DateTimeFormatInfoImpl__ses extends DateTimeFormatInfoImpl {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!DateTimeFormatInfoImpl__ses}
  * @public
  */
 static $create__() {
  DateTimeFormatInfoImpl__ses.$clinit();
  let $instance = new DateTimeFormatInfoImpl__ses();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ses__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ses__() {
 ...
 static $clinit() {
  DateTimeFormatInfoImpl__ses.$clinit = () =>{};
  DateTimeFormatInfoImpl__ses.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof DateTimeFormatInfoImpl__ses;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__ses, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ses');

exports = DateTimeFormatInfoImpl__ses; 
//# sourceMappingURL=DateTimeFormatInfoImpl_ses.js.map