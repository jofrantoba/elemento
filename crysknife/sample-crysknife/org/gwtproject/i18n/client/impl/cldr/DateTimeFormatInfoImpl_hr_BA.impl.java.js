goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_hr_BA$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const DateTimeFormatInfoImpl__hr = goog.require('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_hr$impl');
...
class DateTimeFormatInfoImpl__hr__BA extends DateTimeFormatInfoImpl__hr {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_hr_BA__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_hr_BA__() {
  this.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_hr__();
 }
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__hr__BA, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_hr_BA');
