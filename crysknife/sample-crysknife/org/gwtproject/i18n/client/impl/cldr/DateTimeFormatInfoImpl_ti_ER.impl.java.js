goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ti_ER$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const DateTimeFormatInfoImpl__ti = goog.require('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ti$impl');
...
class DateTimeFormatInfoImpl__ti__ER extends DateTimeFormatInfoImpl__ti {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ti_ER__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ti_ER__() {
  this.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_ti__();
 }
 /**
  * @override
  * @return {Array<?string>}
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__ti__ER, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_ti_ER');
