goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_fr_TN$impl');
...
class DateTimeFormatInfoImpl__fr__TN extends DateTimeFormatInfoImpl__fr {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_fr_TN__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_fr_TN__() {
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__fr__TN, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_fr_TN');
