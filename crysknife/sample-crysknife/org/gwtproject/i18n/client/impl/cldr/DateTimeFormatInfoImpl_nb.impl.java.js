goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_nb$impl');
...
class DateTimeFormatInfoImpl__nb extends DateTimeFormatInfoImpl {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!DateTimeFormatInfoImpl__nb} */
 static $create__() {
  DateTimeFormatInfoImpl__nb.$clinit();
  let $instance = new DateTimeFormatInfoImpl__nb();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_nb__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_nb__() {
 ...
 /** @override @return {Array<?string>} */
 m_erasFull__() {
  return /**@type {!Array<?string>}*/ ($Arrays.$init(["f\u00F8r Kristus", "etter Kristus"], j_l_String));
 }
 /** @override @return {Array<?string>} */
 m_erasShort__() {
 ...
 static $clinit() {
  DateTimeFormatInfoImpl__nb.$clinit = () =>{};
  DateTimeFormatInfoImpl__nb.$loadModules();
  DateTimeFormatInfoImpl.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof DateTimeFormatInfoImpl__nb;
 }
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__nb, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_nb');

exports = DateTimeFormatInfoImpl__nb; 
//# sourceMappingURL=DateTimeFormatInfoImpl_nb.js.map