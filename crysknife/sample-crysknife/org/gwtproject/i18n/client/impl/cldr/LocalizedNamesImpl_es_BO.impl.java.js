goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_BO$impl');
...
class LocalizedNamesImpl__es__BO extends LocalizedNamesImpl__es__419 {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!LocalizedNamesImpl__es__BO} */
 static $create__() {
  LocalizedNamesImpl__es__BO.$clinit();
  let $instance = new LocalizedNamesImpl__es__BO();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_BO__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_BO__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__BO.$clinit = () =>{};
  LocalizedNamesImpl__es__BO.$loadModules();
  LocalizedNamesImpl__es__419.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LocalizedNamesImpl__es__BO;
 }
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__BO, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_BO');

exports = LocalizedNamesImpl__es__BO; 
//# sourceMappingURL=LocalizedNamesImpl_es_BO.js.map