goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_sw_KE$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const DateTimeFormatInfoImpl__sw = goog.require('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_sw$impl');
...
class DateTimeFormatInfoImpl__sw__KE extends DateTimeFormatInfoImpl__sw {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_sw_KE__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_sw_KE__() {
  this.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_sw__();
 }
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__sw__KE, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_sw_KE');
