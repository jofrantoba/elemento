goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_sr_Latn_XK$impl');
...
class DateTimeFormatInfoImpl__sr__Latn__XK extends DateTimeFormatInfoImpl__sr__Latn {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_sr_Latn_XK__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_sr_Latn_XK__() {
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__sr__Latn__XK, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_sr_Latn_XK');
