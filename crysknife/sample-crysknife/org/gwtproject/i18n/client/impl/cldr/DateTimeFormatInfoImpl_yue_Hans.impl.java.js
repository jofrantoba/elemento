goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_yue_Hans$impl');

const $Util = goog.require('nativebootstrap.Util$impl');
const DateTimeFormatInfoImpl__yue = goog.require('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_yue$impl');
...
class DateTimeFormatInfoImpl__yue__Hans extends DateTimeFormatInfoImpl__yue {
 ...
 static $create__() {
  ...
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_yue_Hans__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_yue_Hans__() {
  this.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_yue__();
 }
 /**
  * @override
  * @return {?string}
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__yue__Hans, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_yue_Hans');
