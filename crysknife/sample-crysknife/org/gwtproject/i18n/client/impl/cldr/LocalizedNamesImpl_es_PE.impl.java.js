goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_PE$impl');
...
class LocalizedNamesImpl__es__PE extends LocalizedNamesImpl__es__419 {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!LocalizedNamesImpl__es__PE}
  * @public
  */
 static $create__() {
  LocalizedNamesImpl__es__PE.$clinit();
  let $instance = new LocalizedNamesImpl__es__PE();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_PE__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_PE__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__PE.$clinit = () =>{};
  LocalizedNamesImpl__es__PE.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof LocalizedNamesImpl__es__PE;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__PE, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_PE');

exports = LocalizedNamesImpl__es__PE; 
//# sourceMappingURL=LocalizedNamesImpl_es_PE.js.map