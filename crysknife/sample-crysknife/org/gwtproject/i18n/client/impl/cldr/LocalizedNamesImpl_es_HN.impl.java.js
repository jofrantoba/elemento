goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_HN$impl');
...
class LocalizedNamesImpl__es__HN extends LocalizedNamesImpl__es__419 {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!LocalizedNamesImpl__es__HN} */
 static $create__() {
  LocalizedNamesImpl__es__HN.$clinit();
  let $instance = new LocalizedNamesImpl__es__HN();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_HN__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_HN__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__HN.$clinit = () =>{};
  LocalizedNamesImpl__es__HN.$loadModules();
  LocalizedNamesImpl__es__419.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LocalizedNamesImpl__es__HN;
 }
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__HN, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_HN');

exports = LocalizedNamesImpl__es__HN; 
//# sourceMappingURL=LocalizedNamesImpl_es_HN.js.map