goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_pt_MO$impl');
...
class DateTimeFormatInfoImpl__pt__MO extends DateTimeFormatInfoImpl__pt {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!DateTimeFormatInfoImpl__pt__MO}
  * @public
  */
 static $create__() {
  DateTimeFormatInfoImpl__pt__MO.$clinit();
  let $instance = new DateTimeFormatInfoImpl__pt__MO();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_pt_MO__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_pt_MO__() {
 ...
 static $clinit() {
  DateTimeFormatInfoImpl__pt__MO.$clinit = () =>{};
  DateTimeFormatInfoImpl__pt__MO.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof DateTimeFormatInfoImpl__pt__MO;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__pt__MO, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_pt_MO');

exports = DateTimeFormatInfoImpl__pt__MO; 
//# sourceMappingURL=DateTimeFormatInfoImpl_pt_MO.js.map