goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_pt_TL$impl');
...
class DateTimeFormatInfoImpl__pt__TL extends DateTimeFormatInfoImpl__pt {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!DateTimeFormatInfoImpl__pt__TL} */
 static $create__() {
  DateTimeFormatInfoImpl__pt__TL.$clinit();
  let $instance = new DateTimeFormatInfoImpl__pt__TL();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_pt_TL__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_pt_TL__() {
 ...
 static $clinit() {
  DateTimeFormatInfoImpl__pt__TL.$clinit = () =>{};
  DateTimeFormatInfoImpl__pt__TL.$loadModules();
  DateTimeFormatInfoImpl__pt.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof DateTimeFormatInfoImpl__pt__TL;
 }
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__pt__TL, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_pt_TL');

exports = DateTimeFormatInfoImpl__pt__TL; 
//# sourceMappingURL=DateTimeFormatInfoImpl_pt_TL.js.map