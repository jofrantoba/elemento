goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_PA$impl');
...
class LocalizedNamesImpl__es__PA extends LocalizedNamesImpl__es__419 {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!LocalizedNamesImpl__es__PA} */
 static $create__() {
  LocalizedNamesImpl__es__PA.$clinit();
  let $instance = new LocalizedNamesImpl__es__PA();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_PA__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_PA__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__PA.$clinit = () =>{};
  LocalizedNamesImpl__es__PA.$loadModules();
  LocalizedNamesImpl__es__419.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LocalizedNamesImpl__es__PA;
 }
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__PA, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_PA');

exports = LocalizedNamesImpl__es__PA; 
//# sourceMappingURL=LocalizedNamesImpl_es_PA.js.map