goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_fr_CA$impl');
...
class LocalizedNamesImpl__fr__CA extends LocalizedNamesImpl__fr {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!LocalizedNamesImpl__fr__CA}
  * @public
  */
 static $create__() {
  LocalizedNamesImpl__fr__CA.$clinit();
  let $instance = new LocalizedNamesImpl__fr__CA();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_fr_CA__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_fr_CA__() {
 ...
 m_loadNameMap__() {
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("030", "Asie orientale");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("039", "Europe m\u00E9ridionale");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("145", "Asie occidentale");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("151", "Europe orientale");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("154", "Europe septentrionale");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("155", "Europe occidentale");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("AC", "\u00EEle de l\u2019Ascension");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("AX", "\u00EEles d\u2019\u00C5land");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("CC", "\u00EEles Cocos (Keeling)");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("FM", "Micron\u00E9sie");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("MF", "Saint-Martin (France)");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("MM", "Myanmar");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("MP", "Mariannes du Nord");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("QO", "Oc\u00E9anie lointaine");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("RE", "la R\u00E9union");
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("SX", "Saint-Martin (Pays-Bas)");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("VA", "Cit\u00E9 du Vatican");
  ...
  this.f_namesMap__org_gwtproject_i18n_client_DefaultLocalizedNamesBase.put("VI", "\u00EEles Vierges am\u00E9ricaines");
 }
 /**
  * @public
  */
 static $clinit() {
  LocalizedNamesImpl__fr__CA.$clinit = () =>{};
  LocalizedNamesImpl__fr__CA.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof LocalizedNamesImpl__fr__CA;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(LocalizedNamesImpl__fr__CA, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_fr_CA');

exports = LocalizedNamesImpl__fr__CA; 
//# sourceMappingURL=LocalizedNamesImpl_fr_CA.js.map