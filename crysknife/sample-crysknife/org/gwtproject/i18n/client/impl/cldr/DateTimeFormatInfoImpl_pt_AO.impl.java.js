goog.module('org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_pt_AO$impl');
...
class DateTimeFormatInfoImpl__pt__AO extends DateTimeFormatInfoImpl__pt {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!DateTimeFormatInfoImpl__pt__AO} */
 static $create__() {
  DateTimeFormatInfoImpl__pt__AO.$clinit();
  let $instance = new DateTimeFormatInfoImpl__pt__AO();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_pt_AO__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_DateTimeFormatInfoImpl_pt_AO__() {
 ...
 static $clinit() {
  DateTimeFormatInfoImpl__pt__AO.$clinit = () =>{};
  DateTimeFormatInfoImpl__pt__AO.$loadModules();
  DateTimeFormatInfoImpl__pt.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof DateTimeFormatInfoImpl__pt__AO;
 }
...
$Util.$setClassMetadata(DateTimeFormatInfoImpl__pt__AO, 'org.gwtproject.i18n.client.impl.cldr.DateTimeFormatInfoImpl_pt_AO');

exports = DateTimeFormatInfoImpl__pt__AO; 
//# sourceMappingURL=DateTimeFormatInfoImpl_pt_AO.js.map