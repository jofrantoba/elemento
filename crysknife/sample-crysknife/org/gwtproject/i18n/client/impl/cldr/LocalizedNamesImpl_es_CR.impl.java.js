goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_CR$impl');
...
class LocalizedNamesImpl__es__CR extends LocalizedNamesImpl__es__419 {
 /** @protected */
 constructor() {
  super();
 }
 /** @return {!LocalizedNamesImpl__es__CR} */
 static $create__() {
  LocalizedNamesImpl__es__CR.$clinit();
  let $instance = new LocalizedNamesImpl__es__CR();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_CR__();
  return $instance;
 }
 
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_CR__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__CR.$clinit = () =>{};
  LocalizedNamesImpl__es__CR.$loadModules();
  LocalizedNamesImpl__es__419.$clinit();
 }
 /** @return {boolean} */
 static $isInstance(/** ? */ instance) {
  return instance instanceof LocalizedNamesImpl__es__CR;
 }
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__CR, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_CR');

exports = LocalizedNamesImpl__es__CR; 
//# sourceMappingURL=LocalizedNamesImpl_es_CR.js.map