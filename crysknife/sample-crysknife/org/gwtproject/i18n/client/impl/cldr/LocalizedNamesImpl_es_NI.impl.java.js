goog.module('org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_NI$impl');
...
class LocalizedNamesImpl__es__NI extends LocalizedNamesImpl__es__419 {
 /**
  * @protected
  */
 constructor() {
 ...
 /**
  * @return {!LocalizedNamesImpl__es__NI}
  * @public
  */
 static $create__() {
  LocalizedNamesImpl__es__NI.$clinit();
  let $instance = new LocalizedNamesImpl__es__NI();
  $instance.$ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_NI__();
  return $instance;
 }
 /**
  * @public
  */
 $ctor__org_gwtproject_i18n_client_impl_cldr_LocalizedNamesImpl_es_NI__() {
 ...
 static $clinit() {
  LocalizedNamesImpl__es__NI.$clinit = () =>{};
  LocalizedNamesImpl__es__NI.$loadModules();
 ...
 static $isInstance(instance) {
  return instance instanceof LocalizedNamesImpl__es__NI;
 }
 /**
  * @public
  */
...
$Util.$setClassMetadata(LocalizedNamesImpl__es__NI, 'org.gwtproject.i18n.client.impl.cldr.LocalizedNamesImpl_es_NI');

exports = LocalizedNamesImpl__es__NI; 
//# sourceMappingURL=LocalizedNamesImpl_es_NI.js.map