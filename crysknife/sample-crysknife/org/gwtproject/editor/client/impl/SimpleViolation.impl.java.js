...
class SimpleViolation extends j_l_Object {
  ...
  * @public
  */
 static m_iterableFromConstrantViolations__java_lang_Iterable(violations) {
  ...
  * @public
  */
 static m_pushViolations__java_lang_Iterable__org_gwtproject_editor_client_EditorDriver__org_gwtproject_editor_client_impl_DelegateMap_KeyMethod(violations, driver, keyMethod) {
  SimpleViolation.$clinit();
  ...
  * @public
  */
 static m_getParentPath__java_lang_String(absolutePath) {
 ...
 /**
  * @param {DelegateMap} delegateMap
  * @param {AbstractEditorDelegate<?, ?>} baseDelegate
  * @param {?string} absolutePath
  * @param {SimpleViolation} error
  * @return {boolean}
  * @public
  */
 static m_processEditors__org_gwtproject_editor_client_impl_DelegateMap__org_gwtproject_editor_client_impl_AbstractEditorDelegate__java_lang_String__org_gwtproject_editor_client_impl_SimpleViolation(delegateMap, baseDelegate, absolutePath, error) {
  ...
  * @public
  */
 static m_processLeafDelegates__org_gwtproject_editor_client_impl_DelegateMap__java_lang_String__java_lang_String__org_gwtproject_editor_client_impl_SimpleViolation(delegateMap, originalAbsolutePath, absolutePath, error) {
