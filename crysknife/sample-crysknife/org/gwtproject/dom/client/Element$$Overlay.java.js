goog.module('org.gwtproject.dom.client.Element.$Overlay');

goog.require('nativebootstrap.Util');
goog.require('elemental2.dom.Element.$Overlay');
goog.require('elemental2.dom.Event.$Overlay');
goog.require('elemental2.dom.HTMLElement.$Overlay');
goog.require('elemental2.dom.ViewCSS.$Overlay');
...
goog.require('org.gwtproject.dom.client.Element.UserAgentHolder');
...
const org_gwtproject_dom_client_Element_$Overlay = goog.require('org.gwtproject.dom.client.Element.$Overlay$impl');
