...
class $1 extends j_l_Object {
 ...
 constructor() {
  super();
  /** @public {ButtonCellBase__DefaultAppearance__ResourcesImpl} */
 ...
 /**
  * @param {ButtonCellBase__DefaultAppearance__ResourcesImpl} $outer_this
  * @return {!$1}
  * @public
  */
 static $create__org_gwtproject_cell_client_ButtonCellBase_DefaultAppearance_ResourcesImpl($outer_this) {
  $1.$clinit();
  let $instance = new $1();
  ...
  * @public
  */
 $ctor__org_gwtproject_cell_client_ButtonCellBase_DefaultAppearance_ResourcesImpl_1__org_gwtproject_cell_client_ButtonCellBase_DefaultAppearance_ResourcesImpl($outer_this) {
