...
class Layout extends j_l_Object {
 ...
 /** @return {!Layout} */
 static $create__org_gwtproject_dom_client_Element(/** Object */ parent) {
  Layout.$clinit();
 ...
 $ctor__org_gwtproject_layout_client_Layout__org_gwtproject_dom_client_Element(/** Object */ parent) {
 ...
 m_assertIsChild__org_gwtproject_dom_client_Element(/** Object */ elem) {
 ...
 /** @return {Layer} */
 m_attachChild__org_gwtproject_dom_client_Element(/** Object */ child) {
  return this.m_attachChild__org_gwtproject_dom_client_Element__org_gwtproject_dom_client_Element(child, null);
 }
 /** @return {Layer} */
 m_attachChild__org_gwtproject_dom_client_Element__org_gwtproject_dom_client_Element(/** Object */ child, /** Object */ before) {
 ...
 /** @return {Layer} */
 m_attachChild__org_gwtproject_dom_client_Element__java_lang_Object(/** Object */ child, /** * */ userObject) {
 ...
 /** @return {Layer} */
 m_attachChild__org_gwtproject_dom_client_Element__org_gwtproject_dom_client_Element__java_lang_Object(/** Object */ child, /** Object */ before, /** * */ userObject) {
 ...
 /** @return {number} */
 m_getUnitSize__org_gwtproject_dom_style_shared_Unit__boolean(/** Unit */ unit, /** boolean */ vertical) {
 ...
 m_layout__int(/** number */ duration) {
  this.m_layout__int__org_gwtproject_layout_client_Layout_AnimationCallback(duration, null);
 }
 
 m_layout__int__org_gwtproject_layout_client_Layout_AnimationCallback(/** number */ duration, /** AnimationCallback */ callback) {
 ...
 m_removeChild__org_gwtproject_layout_client_Layout_Layer(/** Layer */ layer) {
 ...
 m_adjustHorizontalConstraints__int__org_gwtproject_layout_client_Layout_Layer_$p_org_gwtproject_layout_client_Layout(/** number */ parentWidth, /** Layer */ l) {
 ...
 m_adjustVerticalConstraints__int__org_gwtproject_layout_client_Layout_Layer_$p_org_gwtproject_layout_client_Layout(/** number */ parentHeight, /** Layer */ l) {
