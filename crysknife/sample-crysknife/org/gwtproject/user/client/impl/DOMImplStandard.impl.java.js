...
class DOMImplStandard extends DOMImpl {
  ...
  * @public
  */
 static m_addBitlessEventDispatchers__org_gwtproject_core_client_JavaScriptObject(eventMap) {
  ...
  * @public
  */
 static m_addCaptureEventDispatchers__org_gwtproject_core_client_JavaScriptObject(eventMap) {
  DOMImplStandard.$clinit();
  DOMImplStandard.m_ensureInit__();
  ...
  * @public
  */
 static m_dispatchEvent__org_gwtproject_user_client_Event(evt) {
  DOMImplStandard.$clinit();
  ...
  * @public
  */
 static m_getFirstAncestorWithListener__org_gwtproject_user_client_Event(evt) {
  ...
  * @public
  */
 static m_dispatchDragEvent__org_gwtproject_user_client_Event(evt) {
  ...
  * @public
  */
 static m_dispatchUnhandledEvent__org_gwtproject_user_client_Event(evt) {
  ...
  * @public
  */
 static m_dispatchCapturedEvent__org_gwtproject_user_client_Event(evt) {
  ...
  * @public
  */
 static m_dispatchCapturedMouseEvent__org_gwtproject_user_client_Event(evt) {
  ...
  * @public
  */
 m_getChildIndex__org_gwtproject_dom_client_Element__org_gwtproject_dom_client_Element(parent, toFind) {
  let count = 0;
  ...
  * @public
  */
 m_insertChild__org_gwtproject_dom_client_Element__org_gwtproject_dom_client_Element__int(parent, toAdd, index) {
  let count = 0;
  let child = parent.firstChild;
  let before = null;
  while (!$Equality.$same(child, null)) {
  ...
  * @public
  */
 m_sinkBitlessEventImpl__org_gwtproject_dom_client_Element__java_lang_String(elem, eventTypeName) {
  ...
  * @public
  */
 m_sinkEventsImpl__org_gwtproject_dom_client_Element__int(elem, bits) {
