...
class $LambdaAdaptor extends j_l_Object {
 ...
 $ctor__org_gwtproject_user_client_ui_NamedFrame_IFrameTemplate_$LambdaAdaptor__org_gwtproject_user_client_ui_NamedFrame_IFrameTemplate_$JsFunction(/** ?function(?string):SafeHtml */ fn) {
