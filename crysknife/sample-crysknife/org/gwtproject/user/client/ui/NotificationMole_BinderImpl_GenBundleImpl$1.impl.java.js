...
class $1 extends j_l_Object {
 ...
 constructor() {
  super();
  /**@type {NotificationMole__BinderImpl__GenBundleImpl}*/
 ...
 /** @return {!$1} */
 static $create__org_gwtproject_user_client_ui_NotificationMole_BinderImpl_GenBundleImpl(/** NotificationMole__BinderImpl__GenBundleImpl */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
 ...
 $ctor__org_gwtproject_user_client_ui_NotificationMole_BinderImpl_GenBundleImpl_1__org_gwtproject_user_client_ui_NotificationMole_BinderImpl_GenBundleImpl(/** NotificationMole__BinderImpl__GenBundleImpl */ $outer_this) {
