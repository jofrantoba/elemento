...
class PrefixTreeIterator extends j_l_Object {
 ...
 $ctor__org_gwtproject_user_client_ui_PrefixTree_PrefixTreeIterator__org_gwtproject_user_client_ui_PrefixTree(/** PrefixTree */ tree) {
 ...
 m_addTree__org_gwtproject_user_client_ui_PrefixTree__java_lang_String_$p_org_gwtproject_user_client_ui_PrefixTree_PrefixTreeIterator(/** PrefixTree */ tree, /** ?string */ prefix) {
 ...
 /** @return {?string} */
 m_nextImpl__boolean_$p_org_gwtproject_user_client_ui_PrefixTree_PrefixTreeIterator(/** boolean */ peek) {
