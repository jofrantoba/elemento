...
class ClippedImageImpl extends j_l_Object {
 ...
 m_adjust__org_gwtproject_dom_client_Element__org_gwtproject_safehtml_shared_SafeUri__int__int__int__int(/** Object */ img, /** SafeUri */ url, /** number */ left, /** number */ top, /** number */ width, /** number */ height) {
 ...
 /** @return {Object} */
 m_createStructure__org_gwtproject_safehtml_shared_SafeUri__int__int__int__int(/** SafeUri */ url, /** number */ left, /** number */ top, /** number */ width, /** number */ height) {
 ...
 /** @return {Object} */
 m_getImgElement__org_gwtproject_user_client_ui_Image(/** Image */ image) {
  return image.m_getElement__();
 }
 /** @return {SafeHtml} */
 m_getSafeHtml__org_gwtproject_safehtml_shared_SafeUri__int__int__int__int(/** SafeUri */ url, /** number */ left, /** number */ top, /** number */ width, /** number */ height) {
 ...
 /** @return {SafeHtml} */
 m_getSafeHtml__org_gwtproject_safehtml_shared_SafeUri__int__int__int__int__boolean(/** SafeUri */ url, /** number */ left, /** number */ top, /** number */ width, /** number */ height, /** boolean */ isDraggable) {
