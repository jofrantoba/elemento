...
class $LambdaAdaptor extends j_l_Object {
 ...
 constructor(/** ?function(?string, ?string, ?string, ?string, ?string):SafeHtml */ fn) {
  $LambdaAdaptor.$clinit();
  super();
  /**@type {?function(?string, ?string, ?string, ?string, ?string):SafeHtml}*/
 ...
 $ctor__org_gwtproject_user_client_ui_NotificationMole_BinderImpl_Template_$LambdaAdaptor__org_gwtproject_user_client_ui_NotificationMole_BinderImpl_Template_$JsFunction(/** ?function(?string, ?string, ?string, ?string, ?string):SafeHtml */ fn) {
