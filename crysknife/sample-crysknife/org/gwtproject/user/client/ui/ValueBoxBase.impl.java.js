...
class ValueBoxBase extends FocusWidget {
  ...
  * @return {!ValueBoxBase<T>}
  * @public
  */
 static $create__org_gwtproject_dom_client_Element__org_gwtproject_text_shared_Renderer__org_gwtproject_text_shared_Parser(elem, renderer, parser) {
  ValueBoxBase.$clinit();
  ...
  * @public
  */
 $ctor__org_gwtproject_user_client_ui_ValueBoxBase__org_gwtproject_dom_client_Element__org_gwtproject_text_shared_Renderer__org_gwtproject_text_shared_Parser(elem, renderer, parser) {
  ...
  * @public
  */
 m_setAlignment__org_gwtproject_user_client_ui_ValueBoxBase_TextAlignment(align) {
  ...
  * @public
  */
 m_setSelectionRange__int__int(pos, length) {
