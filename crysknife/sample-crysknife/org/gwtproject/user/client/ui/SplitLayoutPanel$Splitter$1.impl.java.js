...
class $1 extends j_l_Object {
 ...
 /**
  * @param {Splitter} $outer_this
  * @return {!$1}
  * @public
  */
 static $create__org_gwtproject_user_client_ui_SplitLayoutPanel_Splitter($outer_this) {
  $1.$clinit();
  let $instance = new $1();
  ...
  * @public
  */
 $ctor__org_gwtproject_user_client_ui_SplitLayoutPanel_Splitter_1__org_gwtproject_user_client_ui_SplitLayoutPanel_Splitter($outer_this) {
