...
class RenderableStamper extends j_l_Object {
 ...
 static $create__java_lang_String(/** ?string */ token) {
 ...
 $ctor__org_gwtproject_user_client_ui_RenderableStamper__java_lang_String(/** ?string */ token) {
 ...
 /** @return {SafeHtml} */
 m_stamp__org_gwtproject_safehtml_shared_SafeHtml(/** SafeHtml */ safeHtml) {
 ...
 /** @template T @return {T} */
 m_stamp__org_gwtproject_dom_builder_shared_HtmlElementBuilderBase(/** T */ elementBuilder) {
