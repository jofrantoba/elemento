...
class DefaultMonthSelector extends MonthSelector {
 ...
 /** @return {PushButton} */
 m_createNavigationButton__java_lang_String__int__java_lang_String_$p_org_gwtproject_user_datepicker_client_DefaultMonthSelector(/** ?string */ label, /** number */ noOfMonths, /** ?string */ styleName) {
 ...
 m_setDate__java_util_Date_$p_org_gwtproject_user_datepicker_client_DefaultMonthSelector(/** Date */ date) {
 ...
 /** @return {number} */
 m_addCell__org_gwtproject_user_client_ui_Widget__java_lang_String_$p_org_gwtproject_user_datepicker_client_DefaultMonthSelector(/** Widget */ widget, /** ?string */ width) {
 ...
 /** @return {number} */
 m_addCell__org_gwtproject_user_client_ui_Widget__java_lang_String__java_lang_String_$p_org_gwtproject_user_datepicker_client_DefaultMonthSelector(/** Widget */ widget, /** ?string */ width, /** ?string */ className) {
