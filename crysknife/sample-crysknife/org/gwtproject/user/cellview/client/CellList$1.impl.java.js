...
class $1 extends j_l_Object {
 ...
 static $create__org_gwtproject_user_cellview_client_CellList(/** CellList<T> */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
 ...
 $ctor__org_gwtproject_user_cellview_client_CellList_1__org_gwtproject_user_cellview_client_CellList(/** CellList<T> */ $outer_this) {
