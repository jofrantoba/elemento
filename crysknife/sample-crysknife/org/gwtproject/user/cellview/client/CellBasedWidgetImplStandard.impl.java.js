...
class CellBasedWidgetImplStandard extends CellBasedWidgetImpl {
  ...
  * @public
  */
 static m_handleNonBubblingEvent__org_gwtproject_user_client_Event(event) {
  ...
  * @public
  */
 static m_isNonBubblingEventHandled__org_gwtproject_dom_client_Element__java_lang_String(elem, typeName) {
  ...
  * @public
  */
 m_sinkEventImpl__org_gwtproject_dom_client_Element__java_lang_String_$p_org_gwtproject_user_cellview_client_CellBasedWidgetImplStandard(elem, typeName) {
