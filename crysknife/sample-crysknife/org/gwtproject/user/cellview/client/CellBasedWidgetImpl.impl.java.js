...
class CellBasedWidgetImpl extends j_l_Object {
 ...
 /** @return {boolean} */
 m_isFocusable__org_gwtproject_dom_client_Element(/** Object */ elem) {
 ...
 m_onBrowserEvent__org_gwtproject_user_client_ui_Widget__org_gwtproject_user_client_Event(/** Widget */ widget, /** Event */ event) {}
 /** @return {SafeHtml} */
 m_processHtml__org_gwtproject_safehtml_shared_SafeHtml(/** SafeHtml */ html) {
  return html;
 }
 ...
 m_sinkEvents__org_gwtproject_user_client_ui_Widget__java_util_Set(/** Widget */ widget, /** Set<?string> */ typeNames) {
