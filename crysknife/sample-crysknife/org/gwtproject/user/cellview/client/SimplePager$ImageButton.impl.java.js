...
class ImageButton extends Image {
 ...
 /** @return {!ImageButton} */
 static $create__org_gwtproject_resources_client_ImageResource__org_gwtproject_resources_client_ImageResource__java_lang_String__java_lang_String(/** ImageResource */ resEnabled, /** ImageResource */ resDiabled, /** ?string */ disabledStyle, /** ?string */ label) {
  ImageButton.$clinit();
 ...
 $ctor__org_gwtproject_user_cellview_client_SimplePager_ImageButton__org_gwtproject_resources_client_ImageResource__org_gwtproject_resources_client_ImageResource__java_lang_String__java_lang_String(/** ImageResource */ resEnabled, /** ImageResource */ resDiabled, /** ?string */ disabledStyle, /** ?string */ label) {
 ...
 m_setDisabled__boolean(/** boolean */ isDisabled) {
