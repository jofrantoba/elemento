...
class PendingState extends DefaultState {
  ...
  * @public
  */
 static $create__org_gwtproject_user_cellview_client_HasDataPresenter_State(state) {
  PendingState.$clinit();
  ...
  * @public
  */
 $ctor__org_gwtproject_user_cellview_client_HasDataPresenter_PendingState__org_gwtproject_user_cellview_client_HasDataPresenter_State(state) {
  ...
  * @public
  */
 m_replaceRange__int__int(start, end) {
