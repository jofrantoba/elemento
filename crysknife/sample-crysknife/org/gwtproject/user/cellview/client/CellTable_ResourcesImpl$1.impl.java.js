...
class $1 extends j_l_Object {
 ...
 /** @return {!$1} */
 static $create__org_gwtproject_user_cellview_client_CellTable_ResourcesImpl(/** CellTable__ResourcesImpl */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
 ...
 $ctor__org_gwtproject_user_cellview_client_CellTable_ResourcesImpl_1__org_gwtproject_user_cellview_client_CellTable_ResourcesImpl(/** CellTable__ResourcesImpl */ $outer_this) {
