...
class $1 extends j_l_Object {
 ...
 /**
  * @template T
  * @param {DataGrid<T>} $outer_this
  * @return {!$1<T>}
  * @public
  */
 static $create__org_gwtproject_user_cellview_client_DataGrid($outer_this) {
  $1.$clinit();
  let $instance = new $1();
  ...
  * @public
  */
 $ctor__org_gwtproject_user_cellview_client_DataGrid_1__org_gwtproject_user_cellview_client_DataGrid($outer_this) {
