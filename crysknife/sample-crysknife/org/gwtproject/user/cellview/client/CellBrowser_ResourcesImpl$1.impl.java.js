...
class $1 extends j_l_Object {
 ...
 constructor() {
  super();
  /**@type {CellBrowser__ResourcesImpl}*/
 ...
 /** @return {!$1} */
 static $create__org_gwtproject_user_cellview_client_CellBrowser_ResourcesImpl(/** CellBrowser__ResourcesImpl */ $outer_this) {
  $1.$clinit();
  let $instance = new $1();
 ...
 $ctor__org_gwtproject_user_cellview_client_CellBrowser_ResourcesImpl_1__org_gwtproject_user_cellview_client_CellBrowser_ResourcesImpl(/** CellBrowser__ResourcesImpl */ $outer_this) {
