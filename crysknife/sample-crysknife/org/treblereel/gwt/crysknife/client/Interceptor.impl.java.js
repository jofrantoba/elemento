...
class Interceptor extends j_l_Object {
 ...
 /**
  * @param {?string} obfuscatedPropertyName
  * @param {BiFunction<*, ?string, *>} function_1
  * @return {Interceptor}
  * @public
  */
 m_addGetPropertyInterceptor__java_lang_String__java_util_function_BiFunction(obfuscatedPropertyName, function_1) {
  ...
  * @public
  */
 m_addGetMethodInterceptor__java_lang_String__java_util_function_BiFunction(obfuscatedPropertyName, function_1) {
