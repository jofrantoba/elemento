...
class BodyObserver extends j_l_Object {
  ...
  * @public
  */
 static m_addAttachObserver__elemental2_dom_HTMLElement__org_jboss_elemento_ObserverCallback(element, callback) {
  BodyObserver.$clinit();
  ...
  * @public
  */
 static m_addDetachObserver__elemental2_dom_HTMLElement__org_jboss_elemento_ObserverCallback(element, callback) {
  BodyObserver.$clinit();
  if (!BodyObserver.f_ready__org_jboss_elemento_BodyObserver_) {
   BodyObserver.m_startObserving__();
  }
  ...
  * @public
  */
 static m_createObserver__elemental2_dom_HTMLElement__org_jboss_elemento_ObserverCallback__java_lang_String(element, callback, attribute) {
