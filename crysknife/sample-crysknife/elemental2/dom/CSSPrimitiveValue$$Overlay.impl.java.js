...
class $Overlay {
 ...
 static $clinit() {
  $Overlay.$clinit = () =>{};
  $Overlay.$loadModules();
  $Overlay.$f_CSS_ATTR__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_ATTR;
  $Overlay.$f_CSS_CM__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_CM;
  $Overlay.$f_CSS_COUNTER__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_COUNTER;
  $Overlay.$f_CSS_DEG__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_DEG;
  $Overlay.$f_CSS_DIMENSION__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_DIMENSION;
  $Overlay.$f_CSS_EMS__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_EMS;
  $Overlay.$f_CSS_EXS__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_EXS;
  $Overlay.$f_CSS_GRAD__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_GRAD;
  $Overlay.$f_CSS_HZ__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_HZ;
  $Overlay.$f_CSS_IDENT__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_IDENT;
  $Overlay.$f_CSS_IN__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_IN;
  $Overlay.$f_CSS_KHZ__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_KHZ;
  $Overlay.$f_CSS_MM__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_MM;
  $Overlay.$f_CSS_MS__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_MS;
  $Overlay.$f_CSS_NUMBER__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_NUMBER;
  $Overlay.$f_CSS_PC__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_PC;
  $Overlay.$f_CSS_PERCENTAGE__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_PERCENTAGE;
  $Overlay.$f_CSS_PT__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_PT;
  $Overlay.$f_CSS_PX__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_PX;
  $Overlay.$f_CSS_RAD__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_RAD;
  $Overlay.$f_CSS_RECT__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_RECT;
  $Overlay.$f_CSS_RGBCOLOR__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_RGBCOLOR;
  $Overlay.$f_CSS_S__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_S;
  $Overlay.$f_CSS_STRING__elemental2_dom_CSSPrimitiveValue_$Overlay = CSSPrimitiveValue.CSS_STRING;
